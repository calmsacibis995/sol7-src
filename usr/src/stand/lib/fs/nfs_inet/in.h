...
#pragma ident	"@(#)in.h	1.5	97/05/14 SMI"	/* SVr4.0 1.5 */
...
/*
 * Boot folks: This file differs from the standard in.h in that
 * u_int part of the union is missing - This has been removed to
 * force the compiler to align the ip header properly.
 */
...
#define	INADDR1_ANY		(ipaddr_t)0x000000ffU	/* XXXX */
 ...
 */
#define	IN_SET_LOOPBACK_ADDR(a)	{(a)->sin_addr.s_addr  = \
	htonl(INADDR_LOOPBACK); (a)->sin_family = AF_INET; }
