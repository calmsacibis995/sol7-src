 ...
 *	All rights reserved.
 */
#pragma ident	"@(#)_libld.h	1.53	98/01/22 SMI"
 ...
 * Local functions.
 */
extern Xword		add_actrel(Half, Rel_desc *, Rel *, Ofl_desc *);
extern Xword		add_outrel(Half, Rel_desc *, Rel *, Ofl_desc *);
extern Xword		allocate_got(Ofl_desc *);
extern Ar_desc *	ar_setup(const char *, Elf *, int, Ofl_desc *);
extern void		ar_member(Ar_desc *, Elf_Arsym *, Ar_aux *, Ar_mem *);
extern Xword		assign_got(Sym_desc *);
extern Xword		assign_got_ndx(Word, Xword, Sym_desc *, Ofl_desc *);
extern void		assign_plt_ndx(Sym_desc *, Ofl_desc *);
extern Xword		do_activerelocs(Ofl_desc *);
...
extern Xword		make_bss(Ofl_desc *, Xword, Xword);
extern Xword		make_got(Ofl_desc *);
extern Xword		make_reloc(Ofl_desc *, Os_desc *);
extern Xword		perform_outreloc(Rel_desc *, Ofl_desc *);
extern Os_desc *	place_section(Ofl_desc *, Is_desc *, int, Word);
extern Xword		process_archive(const char *, int, Ar_desc *,
				Ofl_desc *);
extern Ifl_desc *	process_ifl(const char *, const char *, int, Elf *,
				Half, Ofl_desc *, int *);
extern Xword		process_ordered(Ifl_desc *, Ofl_desc *, Word, Word);
extern Xword		reloc_local(Rel_desc *, Rel *, Ofl_desc *);
extern Xword		reloc_relobj(Boolean, Rel_desc *, Rel *, Ofl_desc *);
extern void		reloc_remain_entry(Rel_desc *, Os_desc *, Ofl_desc *);
extern void		sort_ordered(Ofl_desc *);
extern Xword		sym_copy(Sym_desc *);
extern Xword		sym_process(Is_desc *, Ifl_desc *, Ofl_desc *);
extern Xword		sym_resolve(Sym_desc *, Sym *, Ifl_desc *, Ofl_desc *,
				int);
extern Xword		sym_spec(Ofl_desc *);
extern Xword		vers_def_process(Is_desc *, Ifl_desc *, Ofl_desc *);
extern Xword		vers_need_process(Is_desc *, Ifl_desc *, Ofl_desc *);
extern int		vers_sym_process(Is_desc *, Ifl_desc *);
extern Xword		vers_check_need(Ofl_desc *);
