 ...
 */
#pragma ident	"@(#)profile.h	1.18	98/01/06 SMI"
...
#define	PRF_OUTADDR64	(u_longlong_t)-1	/* Function addresses outside of */
					/*	the range being monitored */
#define	PRF_UNKNOWN	(caddr_t)-2	/* Unknown function address */

#define	PRF_ROUNDUP(x, a) \
		(((unsigned long)(x) + ((long)(a) - 1)) & ~((long)(a) - 1))
#define	PRF_ROUNDWN(x, a) \
			((unsigned long)(x) & ~((long)(a) - 1))
