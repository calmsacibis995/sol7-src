...
#ident "@(#)tables.c 1.4 97/07/18 SMI"
 ...
 *bit pattern: 0000 1111 1100 1reg
 */
struct instable opFP7123[16] = {
/*  [70]  */	INVALID,	INVALID,		INVALID,		INVALID,
/*  [71]  */	INVALID,	{"psrlw",TERM,MMXSH,0},	{"psraw",TERM,MMXSH,0},	{"psllw",TERM,MMXSH,0},
/*  [72]  */	INVALID,	{"psrld",TERM,MMXSH,0},	{"psrad",TERM,MMXSH,0},	{"pslld",TERM,MMXSH,0},
/*  [73]  */	INVALID,	{"psrlq",TERM,MMXSH,0},	INVALID,		{"psllq",TERM,MMXSH,0},
};
...
/*  [40]  */	{"cmovl.o",TERM,MR,0},	{"cmovl.no",TERM,MR,0},	{"cmovl.b",TERM,MR,0},		{"cmovl.ae",TERM,MR,0},
/*  [44]  */	{"cmovl.e",TERM,MR,0},	{"cmovl.ne",TERM,MR,0},	{"cmovl.be",TERM,MR,0},		{"cmovl.a",TERM,MR,0},
/*  [48]  */	{"cmovl.s",TERM,MR,0},	{"cmovl.ns",TERM,MR,0},	{"cmovl.pe",TERM,MR,0},		{"cmovl.po",TERM,MR,0},
/*  [4C]  */	{"cmovl.l",TERM,MR,0},	{"cmovl.ge",TERM,MR,0},	{"cmovl.le",TERM,MR,0},		{"cmovl.g",TERM,MR,0},
...
/*  [60]  */	{"punpcklbw",TERM,MMXL,0}, {"punpcklwd",TERM,MMXL,0}, {"punpckldq",TERM,MMXL,0}, {"packsswb",TERM,MMXL,0},
/*  [64]  */	{"pcmpgtb",TERM,MMXL,0},	{"pcmpgtw",TERM,MMXL,0},	{"pcmpgtd",TERM,MMXL,0},	{"packuswb",TERM,MMXL,0},
/*  [68]  */	{"punpckhbw",TERM,MMXL,0}, {"punpckhwd",TERM,MMXL,0}, {"punpckhdq",TERM,MMXL,0}, {"packssdw",TERM,MMXL,0},
/*  [6C]  */	INVALID,		INVALID,		{"movd",TERM,MMXL,0},	{"movq",TERM,MMXL,0},

/*  [70]  */	INVALID,		{"psrXXX",TERM,MR,0},	{"psrXXX",TERM,MR,0},	{"psrXXX",TERM,MR,0},
/*  [74]  */	{"pcmpeqb",TERM,MMXL,0},	{"pcmpeqw",TERM,MMXL,0},	{"pcmpeqd",TERM,MMXL,0},	{"emms",TERM,GO_ON,0},
/*  [78]  */	INVALID,		INVALID,		INVALID,		INVALID,
/*  [7C]  */	INVALID,		INVALID,		{"movd",TERM,MMXS,0},		{"movq",TERM,MMXS,0},
...
/*  [C0]  */	{"xaddb",TERM,XADDB,0},		{"xadd",TERM,RMw,1},		INVALID,		INVALID,
/*  [C4]  */	INVALID,		INVALID,		INVALID,	{"cmpxchg8b",TERM,M,0},
/*  [C8]  */	INVALID,		INVALID,		INVALID,	INVALID,
/*  [CC]  */	INVALID,		INVALID,		INVALID,	INVALID,

/*  [D0]  */	INVALID,		{"psrlw",TERM,MMXL,0},	{"psrld",TERM,MMXL,0},		{"psrlq",TERM,MMXL,0},
/*  [D4]  */	INVALID,		{"pmullw",TERM,MMXL,0},	INVALID,	INVALID,
/*  [D8]  */	{"psubusb",TERM,MMXL,0}, {"psubusw",TERM,MMXL,0}, INVALID,	{"pand",TERM,MMXL,0},
/*  [DC]  */	{"paddusb",TERM,MMXL,0},	{"paddusw",TERM,MMXL,0},	INVALID,	{"pandn",TERM,MMXL,0},

/*  [E0]  */	INVALID,		{"psraw",TERM,MMXL,0},	{"psrad",TERM,MMXL,0}, INVALID,
/*  [E4]  */	INVALID,		{"pmulhw",TERM,MMXL,0},	INVALID,	INVALID,
/*  [E8]  */	{"psubsb",TERM,MMXL,0},	{"psubsw",TERM,MMXL,0},	INVALID,		{"por",TERM,MMXL,0},
/*  [EC]  */	{"paddsb",TERM,MMXL,0},	{"paddsw",TERM,MMXL,0},	INVALID,	{"pxor",TERM,MMXL,0},

/*  [F0]  */	INVALID,		{"psllw",TERM,MMXL,0},	{"pslld",TERM,MMXL,0},	{"psllq",TERM,MMXL,0},
/*  [F4]  */	INVALID,		{"pmaddwd",TERM,MMXL,0},	INVALID,	INVALID,
/*  [F8]  */	{"psubb",TERM,MMXL,0},	{"psubw",TERM,MMXL,0},	{"psubd",TERM,MMXL,0}, INVALID,
/*  [FC]  */	{"paddb",TERM,MMXL,0},	{"paddw",TERM,MMXL,0},	{"paddd",TERM,MMXL,0}, INVALID,
};
...
/*  [7,4]  */	{"fstsw",TERM,M,0},	{"fucomip",TERM,F,0},	{"fcomip",TERM,F,0},	INVALID,
};
...
struct instable opFP6[8] = {
/* bit pattern:	1101 1011 11yy yxxx */
/*  [00]  */	{"fcmov.nb",TERM,F,0},	{"fcmov.ne",TERM,F,0},	{"fcmov.nbe",TERM,F,0},	{"fcmov.nu",TERM,F,0},
/*  [04]  */	INVALID,		{"fucomi",TERM,F,0},	{"fcomi",TERM,F,0},	INVALID,
};

struct instable opFP7[8] = {
/* bit pattern:	1101 1010 11yy yxxx */
/*  [00]  */	{"fcmov.b",TERM,F,0},	{"fcmov.e",TERM,F,0},	{"fcmov.be",TERM,F,0},	{"fcmov.u",TERM,F,0},
...
/* [8,4] */	{"testb",TERM,RMw,0},	{"test",TERM,RMw,1},	{"xchgb",TERM,RMw,0},	{"xchg",TERM,RMw,1},
/* [8,8] */	{"movb",TERM,RMw,0},	{"mov",TERM,RMw,1},	{"movb",TERM,MRw,0},	{"mov",TERM,MRw,1},
/* [8,C] */	{"movw",TERM,SM,0},	{"lea",TERM,MR,1},	{"movw",TERM,MS,0},	{"pop",TERM,M,1},
