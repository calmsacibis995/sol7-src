 ...
 *	Copyright (c) 1989-1995 Sun Microsystems, Inc.
 */
#ident  "@(#)disasm.c 1.11     98/01/30 SMI"
...
INST	*dsmFind();
FORMAT	*findFmt();
static char *dis_print_ptrarg(char *cp, char *fmt, void *arg);
static char *dis_print(char *cp, char *fmt);
static char *dis_print_longarg(char *cp, char *fmt, unsigned long arg);
...
{"sllx",   OP(2) + OP3(0x25) + XX(1), SHIFTMSK, itShift64, V9_MODE},
{"srl",    OP(2) + OP3(0x26) + XX(0), SHIFTMSK, itShift, V8_MODE | V9_MODE},
{"srlx",   OP(2) + OP3(0x26) + XX(1), SHIFTMSK, itShift64, V9_MODE},
{"sra",    OP(2) + OP3(0x27) + XX(0), SHIFTMSK, itShift, V8_MODE | V9_MODE},
{"srax",   OP(2) + OP3(0x27) + XX(1), SHIFTMSK, itShift64, V9_MODE},
	   /* stbar alias */
...
{"rd",     OP(2) + OP3(0x28) + RS1(0x13) + I(0), OPOP3MSK + RS1MSK + IMSK, itRdsr, V9_VIS_MODE},
        /* from %psr */
...
{"sir",    OP(2) + OP3(0x30) + RD(0xf) + RS1(0) + I(1),
	    ...
	    /* to %gsr */
{"wr",      OP(2) + RD(0x13) + OP3(0x30), OPMSK + RDMSK + OP3MSK, itWrgsr, V9_VIS_MODE},
	    /* to %y */
...
{"fpop2", OP(2) + OP3(0x35), OPOP3MSK, itFpop2, V9_MODE},
	/* IMPDEP1 */
{"edge8",      OP(2) + OP3(0x36) + OPFC(0x0), OPOP3MSK + OPFCMSK, itIU3op, V9_VIS_MODE},
{"edge8l",     OP(2) + OP3(0x36) + OPFC(0x2), OPOP3MSK + OPFCMSK, itIU3op, V9_VIS_MODE},
{"edge16",     OP(2) + OP3(0x36) + OPFC(0x4), OPOP3MSK + OPFCMSK, itIU3op, V9_VIS_MODE},
{"edge16l",    OP(2) + OP3(0x36) + OPFC(0x6), OPOP3MSK + OPFCMSK, itIU3op, V9_VIS_MODE},
{"edge32",     OP(2) + OP3(0x36) + OPFC(0x8), OPOP3MSK + OPFCMSK, itIU3op, V9_VIS_MODE},
{"edge32l",    OP(2) + OP3(0x36) + OPFC(0xA), OPOP3MSK + OPFCMSK, itIU3op, V9_VIS_MODE},

{"array8",     OP(2) + OP3(0x36) + OPFC(0x10), OPOP3MSK + OPFCMSK, itIU3op, V9_VIS_MODE},
{"array16",    OP(2) + OP3(0x36) + OPFC(0x12), OPOP3MSK + OPFCMSK, itIU3op, V9_VIS_MODE},
{"array32",    OP(2) + OP3(0x36) + OPFC(0x14), OPOP3MSK + OPFCMSK, itIU3op, V9_VIS_MODE},
{"alignaddr",  OP(2) + OP3(0x36) + OPFC(0x18), OPOP3MSK + OPFCMSK, itIU3op, V9_VIS_MODE},
{"alignaddrl", OP(2) + OP3(0x36) + OPFC(0x1A), OPOP3MSK + OPFCMSK, itIU3op, V9_VIS_MODE},

{"fcmple16",   OP(2) + OP3(0x36) + OPFC(0x20), OPOP3MSK + OPFCMSK, itDP2Rd, V9_VIS_MODE},
{"fcmpne16",   OP(2) + OP3(0x36) + OPFC(0x22), OPOP3MSK + OPFCMSK, itDP2Rd, V9_VIS_MODE},
{"fcmple32",   OP(2) + OP3(0x36) + OPFC(0x24), OPOP3MSK + OPFCMSK, itDP2Rd, V9_VIS_MODE},
{"fcmpne32",   OP(2) + OP3(0x36) + OPFC(0x26), OPOP3MSK + OPFCMSK, itDP2Rd, V9_VIS_MODE},
{"fcmpgt16",   OP(2) + OP3(0x36) + OPFC(0x28), OPOP3MSK + OPFCMSK, itDP2Rd, V9_VIS_MODE},
{"fcmpeq16",   OP(2) + OP3(0x36) + OPFC(0x2A), OPOP3MSK + OPFCMSK, itDP2Rd, V9_VIS_MODE},
{"fcmpgt32",   OP(2) + OP3(0x36) + OPFC(0x2C), OPOP3MSK + OPFCMSK, itDP2Rd, V9_VIS_MODE},
{"fcmpeq32",   OP(2) + OP3(0x36) + OPFC(0x2E), OPOP3MSK + OPFCMSK, itDP2Rd, V9_VIS_MODE},

{"fmul8x16",   OP(2) + OP3(0x36) + OPFC(0x31), OPOP3MSK + OPFCMSK, itFP3DP, V9_VIS_MODE},
{"fmul8x16au", OP(2) + OP3(0x36) + OPFC(0x33), OPOP3MSK + OPFCMSK, itFP3DP, V9_VIS_MODE},
{"fmul8x16al", OP(2) + OP3(0x36) + OPFC(0x35), OPOP3MSK + OPFCMSK, itFP3DP, V9_VIS_MODE},
{"fmul8sux16", OP(2) + OP3(0x36) + OPFC(0x36), OPOP3MSK + OPFCMSK, itFP3DP, V9_VIS_MODE},
{"fmul8ulx16", OP(2) + OP3(0x36) + OPFC(0x37), OPOP3MSK + OPFCMSK, itFP3DP, V9_VIS_MODE},
{"fmuld8sux16",OP(2) + OP3(0x36) + OPFC(0x38), OPOP3MSK + OPFCMSK, itFP3DP, V9_VIS_MODE},
{"fmuld8ulx16",OP(2) + OP3(0x36) + OPFC(0x39), OPOP3MSK + OPFCMSK, itFP3DP, V9_VIS_MODE},
{"pdist",       OP(2) + OP3(0x36) + OPFC(0x3E), OPOP3MSK + OPFCMSK, itFP3DP, V9_VIS_MODE},

{"fpack32",   OP(2) + OP3(0x36) + OPFC(0x3A), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fpack16",   OP(2) + OP3(0x36) + OPFC(0x3B), OPOP3MSK + OPFCMSK, itFP2op, V9_VIS_MODE},
{"fpackfix",  OP(2) + OP3(0x36) + OPFC(0x3D), OPOP3MSK + OPFCMSK, itFP2op, V9_VIS_MODE},
{"faligndata",OP(2) + OP3(0x36) + OPFC(0x48), OPOP3MSK + OPFCMSK, itDP3op, V9_VIS_MODE},
{"fpmerge",   OP(2) + OP3(0x36) + OPFC(0x4B), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fexpand",   OP(2) + OP3(0x36) + OPFC(0x4D), OPOP3MSK + OPFCMSK, itFP2op, V9_VIS_MODE},

{"fpadd16", OP(2) + OP3(0x36) + OPFC(0x50), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fpadd16s",OP(2) + OP3(0x36) + OPFC(0x51), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fpadd32", OP(2) + OP3(0x36) + OPFC(0x52), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fpadd32s",OP(2) + OP3(0x36) + OPFC(0x53), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fpsub16", OP(2) + OP3(0x36) + OPFC(0x54), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fpsub16s",OP(2) + OP3(0x36) + OPFC(0x55), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fpsub32", OP(2) + OP3(0x36) + OPFC(0x56), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fpsub32s",OP(2) + OP3(0x36) + OPFC(0x57), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},

{"fzero",   OP(2) + OP3(0x36) + OPFC(0x60), OPOP3MSK + OPFCMSK, itArgDregRd, V9_VIS_MODE},
{"fzeros",  OP(2) + OP3(0x36) + OPFC(0x61), OPOP3MSK + OPFCMSK, itArgFregRd, V9_VIS_MODE},
{"fnor",    OP(2) + OP3(0x36) + OPFC(0x62), OPOP3MSK + OPFCMSK, itDP3op, V9_VIS_MODE},
{"fnors",   OP(2) + OP3(0x36) + OPFC(0x63), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fandnot2",OP(2) + OP3(0x36) + OPFC(0x64), OPOP3MSK + OPFCMSK, itDP3op, V9_VIS_MODE},
{"fandnot2s",OP(2) + OP3(0x36) + OPFC(0x65), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fnot2",   OP(2) + OP3(0x36) + OPFC(0x66), OPOP3MSK + OPFCMSK, itDP2op, V9_VIS_MODE},
{"fnot2s",  OP(2) + OP3(0x36) + OPFC(0x67), OPOP3MSK + OPFCMSK, itFP2op, V9_VIS_MODE},
{"fandnot1",OP(2) + OP3(0x36) + OPFC(0x68), OPOP3MSK + OPFCMSK, itDP3op, V9_VIS_MODE},
{"fandnot1s",OP(2) + OP3(0x36) + OPFC(0x69), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fnot1",   OP(2) + OP3(0x36) + OPFC(0x6A), OPOP3MSK + OPFCMSK, itDP1op, V9_VIS_MODE},
{"fnot1s",  OP(2) + OP3(0x36) + OPFC(0x6B), OPOP3MSK + OPFCMSK, itFP1op, V9_VIS_MODE},
{"fxor",    OP(2) + OP3(0x36) + OPFC(0x6C), OPOP3MSK + OPFCMSK, itDP3op, V9_VIS_MODE},
{"fxors",   OP(2) + OP3(0x36) + OPFC(0x6D), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fnand",   OP(2) + OP3(0x36) + OPFC(0x6E), OPOP3MSK + OPFCMSK, itDP3op, V9_VIS_MODE},
{"fnands",  OP(2) + OP3(0x36) + OPFC(0x6F), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},

{"fand",    OP(2) + OP3(0x36) + OPFC(0x70), OPOP3MSK + OPFCMSK, itDP3op, V9_VIS_MODE},
{"fands",   OP(2) + OP3(0x36) + OPFC(0x71), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fxnor",   OP(2) + OP3(0x36) + OPFC(0x72), OPOP3MSK + OPFCMSK, itDP3op, V9_VIS_MODE},
{"fxnors",  OP(2) + OP3(0x36) + OPFC(0x73), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fsrc1",   OP(2) + OP3(0x36) + OPFC(0x74), OPOP3MSK + OPFCMSK, itDP1op, V9_VIS_MODE},
{"fsrc1s",  OP(2) + OP3(0x36) + OPFC(0x75), OPOP3MSK + OPFCMSK, itFP1op, V9_VIS_MODE},
{"fornot2", OP(2) + OP3(0x36) + OPFC(0x76), OPOP3MSK + OPFCMSK, itDP3op, V9_VIS_MODE},
{"fornot2s",OP(2) + OP3(0x36) + OPFC(0x77), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fsrc2",   OP(2) + OP3(0x36) + OPFC(0x78), OPOP3MSK + OPFCMSK, itDP2op, V9_VIS_MODE},
{"fsrc2s",  OP(2) + OP3(0x36) + OPFC(0x79), OPOP3MSK + OPFCMSK, itFP2op, V9_VIS_MODE},
{"fornot1", OP(2) + OP3(0x36) + OPFC(0x7A), OPOP3MSK + OPFCMSK, itDP3op, V9_VIS_MODE},
{"fornot1s",OP(2) + OP3(0x36) + OPFC(0x7B), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"for",     OP(2) + OP3(0x36) + OPFC(0x7C), OPOP3MSK + OPFCMSK, itDP3op, V9_VIS_MODE},
{"fors",    OP(2) + OP3(0x36) + OPFC(0x7D), OPOP3MSK + OPFCMSK, itFP3op, V9_VIS_MODE},
{"fone",    OP(2) + OP3(0x36) + OPFC(0x7E), OPOP3MSK + OPFCMSK, itArgDregRd, V9_VIS_MODE},
{"fones",   OP(2) + OP3(0x36) + OPFC(0x7F), OPOP3MSK + OPFCMSK, itArgFregRd, V9_VIS_MODE},

{"shutdown",OP(2) + OP3(0x36) + OPFC(0x80), OPOP3MSK + OPFCMSK, itNoArg, V9_VIS_MODE},
...
{"ldda",    OP(3) + OP3(0x13), OPOP3MSK, itLdImmAsi, V8_MODE | V9_MODE | V9_VIS_MODE},
	    /* do not spoof STWA */
...
{"ldda",    OP(3) + OP3(0x33), OPOP3MSK, itLdAsiDP, V9_MODE | V9_VIS_MODE},  /* to freg[rd] */
...
{"stda",    OP(3) + OP3(0x37) + I(0) + IMM_ASI(0xC0),
		OPOP3MSK + IMSK + IMM_ASIMSK, itStDPAsiPst, V9_VIS_MODE},  /* groan */
{"stda",    OP(3) + OP3(0x37) + I(0) + IMM_ASI(0xC1),
		OPOP3MSK + IMSK + IMM_ASIMSK, itStDPAsiPst, V9_VIS_MODE},
...
{"stda",    OP(3) + OP3(0x37) + I(0) + IMM_ASI(0xCD),
		OPOP3MSK + IMSK + IMM_ASIMSK, itStDPAsiPst, V9_VIS_MODE},
{"stda",    OP(3) + OP3(0x37), OPOP3MSK, itStAsiDP, V9_MODE | V9_VIS_MODE},
...
int	dismode = V8_MODE;	/* indicates disassembly mode */
...
disassemble(inst, pc)
	...
	unsigned long pc;
{
	extern char *toSymbolic();
	register INST *iPtr;

	iPtr = dsmFind(inst);
	(void) dsmPrint(dis_buf, inst, iPtr, pc, pc, toSymbolic);
	return (dis_buf);
}

dsmFetch(addr, instrPtr)
	char	*addr;
	Instruction	*instrPtr;
{
	*instrPtr = chkget(addr, ISP);
	return (1);
}
 ...
 */
static char *
dis_print_ptrarg(char *cp, char *fmt, void *arg)
{
	sprintf(cp, fmt, arg);
	cp += strlen(cp);
	return (cp);
...
static char *
dis_print_longarg(char *cp, char *fmt, unsigned long arg)
{
	sprintf(cp, fmt, arg);
	cp += strlen(cp);
	return (cp);
	...
	for (; *fmtptr != atEnd; fmtptr++) {
		...
		case atOp:
			if ((*(fmtptr+1) == atAnnul) &&
			    ((bits & AMSK) == A(1))) {
				register int i, n;
				cp = dis_print_ptrarg(cp, "%s", iPtr->name);
				n = strlen(iPtr->name);
				cp = dis_print_ptrarg(cp, "%s", ",a");
				n = 8 - (n + 2);
				for (i = 0; i < n; i++)
					cp[i] = ' ';
				cp += n;
		...
		case atTrap:
		case atAddress:
			if (((uintptr_t)InstPtr != 0) &&
				((Instruction)InstPtr != bits))
				(void) dsmFetch((char *)(InstPtr), &pBits);
		...
		case atImm22:
			if (((uintptr_t)InstPtr != 0) && 
				((Instruction)InstPtr != bits)) {
				db_printf(8,"calling dsmFetch %J\n", (InstPtr +1));
				if (dsmFetch((char *)(InstPtr + 1), &nBits) == 0)
					return (cp);
			}
			db_printf(8,"nBits is %X\n", nBits);
			db_printf(8,"....\n");
			db_printf(8,"....\n");
			cp = dis_print(cp, "%%hi(");
		...
		case atFcn:
			cp = dis_print_longarg(cp, "%d",
			    (bits >> RD_SHIFT_CT) & 0x1F);
			break;
	...
	FUNCPTR		prtAddress;	/* Routine to print addresses */
{
	if (checkLo(fmt, pBits, bits) == 1) {
		...
		if ((bits & RS1MSK) == RS1(0)) {
			cp = dis_print_longarg(cp, "0x%x", sign_extend13(bits));
		} else {
			cp = prtReg(cp, bits >> RS1_SHIFT_CT);
			if ((bits & SIMM13) != 0) {
	...
	register Instruction bits;	/* Bits of current instruction */
{
	...
	if ((bits & SIMM13_SIGN) == SIMM13_SIGN)
		cp = dis_print(cp, "-");
        cp = dis_print_longarg(cp, "0x%x", abs(seval));
...
prtConst22(cp, bits)
	...
	register Instruction bits;	/* Bits of current instruction */
{
	cp = dis_print_longarg(cp, "0x%x", (bits & CONST22));
	return (cp);
}
	...
	FUNCPTR		  prtAddress;	/* Routine to print addresses */
{
	...
	if ((bits & DISP22_SIGN) != 0)
		cp = dis_print_ptrarg(cp, "%s", prtAddress((addr + (int)
			(((bits & DISP22) |
				DISP22_SIGN_EXTEND) << DISP22_SHIFT_CT))));
	else
		cp = dis_print_ptrarg(cp, "%s", prtAddress(addr +
...
prtOpfc(cp, bits)
	...
	register Instruction bits;	/* Bits of current instruction */
{
	return (dis_print_longarg(cp,
	    "%03x", ((bits & OPFCMSK) >> OPFC_SHIFT_CT)));
}
	...
	register Instruction bits;	/* Bits of current instruction */
{
	...
	return(dis_print_longarg(cp,
	    "0x%02x", ((bits & ASIMSK) >> ASI_SHIFT_CT)));
}
...
prtReg(cp, bits)
	...
	register Instruction bits;	/* Bits of current instruction */
{
	return (dis_print_ptrarg(cp, "%s", iureg[ (bits & RS2MSK) ]));
}
...
prtFreg(cp, bits)
	...
	register Instruction bits;	/* Bits of current instruction */
{
	return (dis_print_longarg(cp, "%%f%d", (bits & RS2MSK)));
}
	...
	register Instruction bits;	/* Bits of current instruction */
{
	...
	if (reg % 2 != 0)
		reg = (reg + 32) & DBLMSK;
	return (dis_print_longarg(cp, "%%f%d", reg));
}
...
prtCreg(cp, bits)
	...
	register Instruction bits;	/* Bits of current instruction */
{
	return (dis_print_longarg(cp, "%%c%d", (bits & RS2MSK)));
}
...
prtDisp30(cp, addr, bits, prtAddress)
	...
	FUNCPTR		  prtAddress;	/* Routine to print addresses */
{
	return (dis_print_ptrarg(cp, "%s", prtAddress(addr + (int)
...
prtfcc(cp, fcc)
	...
	register u_int fcc;
{
	return(dis_print_longarg(cp, "%%fcc%d, ", (fcc & CCMSK)));
}
	...
	register Instruction bits;	/* Bits of current instruction */
{
	...
	case (OP(2) + OP3(0x30)):		/* wr %y, %asr[rd], etc. */
		...
		default:
			cp = dis_print_longarg(cp, "%%asr%d", (specreg));
			break;
		}
...
prtShcnt64(cp, bits)
	...
	register Instruction	bits;	/* Bits of current instruction */
{
	cp = dis_print_longarg(cp, "%d", (bits & SHCNT64MSK));
	return (cp);
}
...
prtTrap(cp, bits)
	...
	register Instruction	bits;	/* Bits of current instruction */
{
	cp = dis_print_longarg(cp, "%d", (bits & TRAPMSK));
	return (cp);
}
	...
	register Instruction bits;	/* Bits of current instruction */
{
	...
	if ((bits & SIMM10_SIGN) == SIMM10_SIGN)
		cp = dis_print(cp, "-");
        cp = dis_print_longarg(cp, "%d", abs(seval));
	return (cp);
}
...
#ifndef	_KADB
void
change_dismode(int newmode, int pflg)
{
	char *dmode[] = {
		"",
		"SPARC-V8",
	...
	extern int dismode, v9flag;
	int oldmode = dismode;

	switch (dismode = newmode) {
		case V8_MODE:
			v9flag = 0;
			break;
		case V9_MODE:
			...
			break;
		case V9_VIS_MODE:
		case V9_VIS_MODE | V9_MODE:
			v9flag = 1;
			newmode = V9_VIS_MODE;
			dismode = V9_MODE | V9_VIS_MODE;
			break;
		default:
			printf("valid modes: %d(%s), %d(%s), %d(%s)\n",
			    V8_MODE, dmode[V8_MODE], V9_MODE,
			    dmode[V9_MODE], V9_VIS_MODE,
			    dmode[V9_VIS_MODE]);
			dismode = V8_MODE;
			return;
	}
	/*
	 * Make sure not to switch registers if we're going from one form
	 * of V9 to another.
	 */
	if (!(dismode & oldmode))
		xfer_regs();
	if (pflg)
		printf("disassembly mode is %s\n", dmode[newmode]);
}
...
get_platname()
{
	return ((sysinfo(SI_PLATFORM, platname,
	    sizeof (platname)) == -1) ?	0 : 1);
}

/*
 * For "adb -k": check the architecture of the machine we're running on
 * (since /dev/ksyms doesn't tell us) and adjust dismode if necessary.
 */
void
ksyms_dismode()
{
	if (get_platname() && (!strncmp(platname, "SUNW,Ultra", 10)))
		change_dismode(V9_VIS_MODE, 0);
}
#endif	/* !_KADB */
