...
#pragma	ident	"@(#)snoop_display.c 1.19	97/04/19 SMI"
...
char *
showxdr_string(int len, char *fmt)
{
...
getxdr_hex(int len)
{
	...
	(void) xdr_opaque(&xdrm, rbuff, len);
