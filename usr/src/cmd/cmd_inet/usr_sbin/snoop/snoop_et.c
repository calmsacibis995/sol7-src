...
#ident	"@(#)snoop_ether.c	1.16	97/12/04 SMI"	/* SunOS	*/
...
static u_int interpret_ether(), interpret_fddi(), interpret_tr();
	...
	int elen, origlen;
{
	...
	addr_copy_swap(&f->dhost, e+1);
	addr_copy_swap(&f->shost, e+7);
