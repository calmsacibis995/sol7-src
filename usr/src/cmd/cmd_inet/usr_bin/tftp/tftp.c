...
#ident	"@(#)tftp.c	1.9	97/07/16 SMI"	/* SVr4.0 1.5	*/
	...
	int error;
{
	...
	if (sendto(f, ackbuf, length, 0,
	    (struct sockaddr *)&sin, sizeof (sin)) != length)
		perror("nak");
}
