...
#pragma ident	"@(#)rmm_int.h	1.14	96/11/22 SMI"
 ...
 * PCFS "mount" options
 *
 * Note that the "hidden" options are private, they are not approved
 * for use (see PSARC/1996/443) but we should accept them anyway to enable
 * testing.
 */
#define	MA_HIDDEN	0x10000	/* mount it (pcfs) "hidden" */
#define	MA_NOHIDDEN	0x20000	/* mount it (pcfs) "nohidden" */
#define	MA_FOLDCASE	0x40000	/* mount it (pcfs) "foldcase" */
#define	MA_NOFOLDCASE	0x80000	/* mount it (pcfs) "nofoldcase" */
