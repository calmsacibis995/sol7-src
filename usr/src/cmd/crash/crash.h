...
#pragma ident	"@(#)crash.h	1.14	97/09/07 SMI"
...
extern Sym *Panic, *V;
extern void *_userlimit;
extern void *_kernelbase;

extern uintptr_t procv;
extern int opipe;
extern FILE *rp;
extern void sigint(int);
extern void resetfp(void);
extern void readmem(void *, int, int, void *, size_t, char *);
extern void readsym(char *, void *, unsigned);
extern void readbuf(void *, off_t, int, int, void *, size_t, char *);
