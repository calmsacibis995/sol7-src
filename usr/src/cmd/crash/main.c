...
#pragma ident	"@(#)main.c	1.24	97/09/07 SMI"
...
int		active;		/* Set if crash is examining an active system */
...
static struct func	functab[] = {
	...
	"pty",
	"[-e] [-f] [-w filename] [-s] [-h] [-l] [-t type] [([-p] tbl_entry)]",
