...
#pragma ident   "@(#)funct.c 1.3     97/06/23 SMI"
...
Wb_log_entry	*wle;
	...
	bcopy((void *)&(pg3c->wb_log), (void *)wle,
		(size_t)((sizeof (struct wb_log_entry) -
			(P_NPORTS * P_NTARGETS *
				sizeof (struct wb_log_drive_entry))) +
		((pg3c->ports * pg3c->tgts) *
			sizeof (struct wb_log_drive_entry))));
