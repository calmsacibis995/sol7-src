#ifndef USGFS
#ident	"@(#)lftw.c 1.5 90/11/09 SMI" /* from S5R2 1.2 */

#ident	"@(#)lftw.c 1.10 97/03/03"

/*
 * Copyright 1989, 1996 Sun Microsystems, Inc.
 * All rights reserved.
 */
	...
	int depth;
{
	...
	return (lf_xftw(path, fn, depth, stat64));
}
#endif
...
#endif
{
	return (lf_xftw(path, fn, depth, lstat64));
}
