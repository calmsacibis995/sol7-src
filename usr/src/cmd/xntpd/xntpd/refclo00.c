...
#pragma ident	"@(#)refclock_acts.c	1.1	96/11/01 SMI"
 ...
 */
#if defined(ACTS) || !defined(KEEPPTBACTS)
#undef PTBACTS
#endif
#if defined(REFCLOCK) && (defined(ACTS) || defined(PTBACTS))
	...
	struct recvbuf *rbufp;
{
	 ...
	 */
	if (sscanf(pp->lastcode,
	    "%*4d-%*2d-%*2d %*2d:%*2d:%2d %*4c %*12c%4d%2d%2d%2d%2d%5ld%2lf%c%2d%3lf%*15c%c",
