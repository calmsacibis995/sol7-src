...
#pragma ident	"@(#)ntp_filegen.c	1.1	96/11/01 SMI"
...
#ifndef SYS_WINNT
			/* cannot determine how to create links between files under NT */
			/* will do some more investigation later */
#if !defined(VMS)
			if (link(filename, basename) != 0) {
				if (errno != EEXIST)
#else /* VMS */
			/* On VMS, don't support FGEN_FLAG_LINK */
			{
					errno = 0;
#endif /* VMS */
