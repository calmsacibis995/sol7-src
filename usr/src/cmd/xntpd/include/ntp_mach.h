...
#pragma ident	"@(#)ntp_machine.h	1.2	97/06/02 SMI"
...
/*
 * The portable & free BSD 4.4 : NetBSD 1.0 and above
 */
#if defined(SYS_NETBSD)
#ifndef STR_SYSTEM
#define STR_SYSTEM "UNIX/NetBSD"
#endif
#ifndef SYS_44BSD
#define SYS_44BSD
#endif
...
#ifdef SYS_FREEBSD
#ifndef STR_SYSTEM
#define STR_SYSTEM "UNIX/FreeBSD"
#endif
#define HAVE_TERMIOS
#define HAVE_UNAME
...
/*
 * OpenVMS [native as opposed to VMS POSIX] with DECC compiler & DEC TCP/IP
 */
#if defined(VMS) && defined(__DECC)
#ifdef __alpha
#define STR_SYSTEM "OpenVMS AXP"
#else
#define STR_SYSTEM "OpenVMS VAX"
#endif
#define NTP_POSIX_SOURCE
#define USE_PROTOTYPES
...
#endif
#define SLEWALWAYS
#define DOSYNCTODR		/* do set the TOY clock now and then */
#define ADJTIME_IS_ACCURATE	/* as provided by the VMS_*.C routines */
#define HAVE_NO_NICE
#define NOKMEM 
#endif
...
#  define XNTP_LITTLE_ENDIAN
#  undef XNTP_BIG_ENDIAN
# else
#  define XNTP_BIG_ENDIAN
#  undef XNTP_LITTLE_ENDIAN
# endif
#endif
