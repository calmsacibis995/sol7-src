...
#pragma ident	"@(#)clk_rcc8000.c	1.2	96/11/25 SMI"
...
/*
 * $Header: /src/NTP/REPOSITORY/v3/parse/clk_rcc8000.c,v 3.3 1995/02/16 22:37:08 kardel Exp $
 *  
 * $Id: clk_rcc8000.c,v 3.3 1995/02/16 22:37:08 kardel Exp $
 *
...
#endif /* defined(PARSE) && defined(CLOCK_RCC8000) */
