...
#pragma ident	"@(#)clk_schmid.c	1.2	96/11/25 SMI"
...
/*
 * /src/NTP/REPOSITORY/v3/parse/clk_schmid.c,v 3.18 1994/10/03 21:59:26 kardel Exp
 *  
 * clk_schmid.c,v 3.18 1994/10/03 21:59:26 kardel Exp
 *
