...
#pragma ident	"@(#)testdcf.c	1.1	96/11/01 SMI"

/*
 * /src/NTP/REPOSITORY/v3/parse/util/testdcf.c,v 3.14 1994/11/19 17:26:44 kardel Exp
 *  
 * testdcf.c,v 3.14 1994/11/19 17:26:44 kardel Exp
 *
