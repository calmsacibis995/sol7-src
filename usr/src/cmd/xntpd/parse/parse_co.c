...
#pragma ident	"@(#)parse_conf.c	1.2	96/11/25 SMI"
...
/*
 * /src/NTP/REPOSITORY/v3/parse/parse_conf.c,v 3.17 1994/10/03 21:59:35 kardel Exp
 *  
 * parse_conf.c,v 3.17 1994/10/03 21:59:35 kardel Exp
 *
