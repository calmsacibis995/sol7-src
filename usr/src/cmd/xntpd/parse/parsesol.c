...
#pragma ident	"@(#)parsesolaris.c	1.1	96/11/01 SMI"

/*
 * /src/NTP/REPOSITORY/v3/parse/parsesolaris.c,v 3.20 1995/08/06 19:15:20 kardel Exp
 *  
 * parsesolaris.c,v 3.20 1995/08/06 19:15:20 kardel Exp
 *
...
#ifndef lint
static char rcsid[] = "parsesolaris.c,v 3.20 1995/08/06 19:15:20 kardel Exp";
#endif
 ...
 * SKEW BETWEEN THE HW-PPS SIGNAL AND KERNEL gethrestime()
 * YOURSELF.
 *
  ...
  if (setup_stream(q, M_PARSE))
    {
      ...
      if (!notice)
	{
	  printf("%s: Copyright (c) 1993-1995, Frank Kardel\n", modlstrmod.strmod_linkinfo);
	  notice = 1;
	}
