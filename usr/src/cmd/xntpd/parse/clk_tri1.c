...
#pragma ident	"@(#)clk_trimtsip.c	1.3	96/11/25 SMI"
	  ...
	  case 0x4f:
	    {
	      ...
	      int tls   = t->t_gpsutc     = getint((u_char *) &mb(12)); /* current leap correction (GPS-UTC) */
	      int wnlsf = t->t_weekleap   = getint((u_char *) &mb(20)); /* week no of leap correction */
	      int dn    = t->t_dayleap    = getint((u_char *) &mb(22)); /* day in week of leap correction */
	      int tlsf  = t->t_gpsutcleap = getint((u_char *) &mb(24)); /* new leap correction */
	      u_long now, leaptime;

	      t->t_week = getint((u_char *) &mb(18)); /* current week no */
