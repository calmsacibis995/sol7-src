...
#pragma ident	"@(#)clk_meinberg.c	1.2	96/11/25 SMI"
...
/*
 * /src/NTP/REPOSITORY/v3/parse/clk_meinberg.c,v 3.18 1995/03/26 16:10:25 kardel Exp
 *  
 * clk_meinberg.c,v 3.18 1995/03/26 16:10:25 kardel Exp
 *
