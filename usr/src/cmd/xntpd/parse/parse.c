...
#pragma ident	"@(#)parse.c	1.3	96/11/25 SMI"
...
#if defined(PARSESTREAM) && (defined(SYS_SUNOS4) || defined(SYS_SOLARIS)) && defined(STREAM) || defined(SYS_DECOSF1)
/*
 ...
 */
#define dysize(x)	((x) % 4 ? 365 : ((x % 400) ? ((x % 100) ? 366 : 365) : 366))
