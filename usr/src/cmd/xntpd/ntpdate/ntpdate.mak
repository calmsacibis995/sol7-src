...
!MESSAGE 
!MESSAGE NMAKE /f "ntpdate.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/ntpdate.exe $(OUTDIR)/ntpdate.bsc
...
CPP_PROJ=/nologo /MT /W3 /GX /YX /O2 /I "..\include" /D "NDEBUG" /D "WIN32" /D\
 ...
 /D "SYSLOG_FILE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"ntpdate.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
$(OUTDIR)/ntpdate.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"ntpdate.pdb" /MACHINE:I386\
 /OUT:$(OUTDIR)/"ntpdate.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/ntpdate.obj

$(OUTDIR)/ntpdate.exe : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /MT /W3 /GX /Zi /YX /Od /I "..\include" /D "_DEBUG" /D "WIN32"\
 ...
 "DEBUG" /D "SYSLOG_FILE" /FR$(INTDIR)/ /Fp$(OUTDIR)/"ntpdate.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"ntpdate.pdb" /c 
CPP_OBJS=.\WinDebug/
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib wsock32.lib winmm.lib ..\lib\WinDebug\libntp.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"ntpdate.pdb" /DEBUG\
 /MACHINE:I386 /OUT:$(OUTDIR)/"ntpdate.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/ntpdate.obj
...
$(INTDIR)/ntpdate.obj :  $(SOURCE)  $(INTDIR)
