/* Copyright 01/09/97 Sun Microsystems, Inc. All Rights Reserved.
 */
#pragma ident  "@(#)parse.c	1.6 97/01/09 Sun Microsystems"
...
printf("parse_traptype() invoked\n");
   ...
   if( type == ENTERPRISE){
	...
	/* create a trap item */
	ti = (struct trap_item*)malloc(sizeof(struct trap_item));	
	if(ti==NULL){ fprintf(stderr,"malloc failed\n"); return 0; }
