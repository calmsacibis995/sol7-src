...
Object object_table[] = {
/*      0 */ { { &subid_table[0], 10 }, STRING, NULL, READ_FLAG | WRITE_FLAG, get_relayProcessIDFile, set_relayProcessIDFile,free_relayProcessIDFile },
/*      1 */ { { &subid_table[10], 10 }, STRING, NULL, READ_FLAG | WRITE_FLAG, get_relayResourceFile, set_relayResourceFile,free_relayResourceFile },
/*      2 */ { { &subid_table[20], 10 }, STRING, NULL, READ_FLAG | WRITE_FLAG, get_relayPersonalFileDir, set_relayPersonalFileDir,free_relayPersonalFileDir },
/*      3 */ { { &subid_table[30], 10 }, INTEGER, NULL, READ_FLAG, get_relayTrapPort, NULL,NULL },
/*      4 */ { { &subid_table[40], 10 }, STRING, NULL, READ_FLAG | WRITE_FLAG, get_relayCheckPoint, set_relayCheckPoint,free_relayCheckPoint },
/*      5 */ { { &subid_table[50], 10 }, INTEGER, NULL, READ_FLAG, get_relayPollInterval, NULL,NULL },
/*      6 */ { { &subid_table[60], 10 }, INTEGER, NULL, READ_FLAG, get_relayMaxAgentTimeOut, NULL,NULL },
/*      7 */ { { &subid_table[214], 10 }, INTEGER, NULL, READ_FLAG | WRITE_FLAG, get_agentTableIndex, set_agentTableIndex,NULL },
/*      8 */ { { &subid_table[320], 10 }, INTEGER, NULL, READ_FLAG, get_regTblTableIndex, NULL,NULL },
/*      9 */ { { &subid_table[378], 10 }, INTEGER, NULL, READ_FLAG, get_regTreeTableIndex, NULL,NULL },
{ { NULL, 0}, 0, NULL, 0, NULL, NULL }
};
int object_table_size = 10;

Index index_table[] = {
/*      0 */ {              NULL, "agentID", &node_table[28] },
/*      1 */ { &index_table[   2], "regTblAgentID", &node_table[44] },
/*      2 */ {              NULL, "regTblIndex", &node_table[43] },
/*      3 */ { &index_table[   4], "regTreeAgentID", &node_table[55] },
/*      4 */ {              NULL, "regTreeIndex", &node_table[54] },
{ NULL, NULL, NULL }
};
...
Column column_table[] = {
/*      0 */ { { &subid_table[70], 12 }, INTEGER, NULL, READ_FLAG, NULL, &entry_table[0], 0 },
/*      1 */ { { &subid_table[82], 12 }, INTEGER, &enum_table[0], READ_FLAG | WRITE_FLAG, set_agentStatus, &entry_table[0], 4 },
/*      2 */ { { &subid_table[94], 12 }, INTEGER, NULL, READ_FLAG | WRITE_FLAG, set_agentTimeOut, &entry_table[0], 8 },
/*      3 */ { { &subid_table[106], 12 }, INTEGER, NULL, READ_FLAG | WRITE_FLAG, set_agentPortNumber, &entry_table[0], 12 },
/*      4 */ { { &subid_table[118], 12 }, STRING, NULL, READ_FLAG | WRITE_FLAG, set_agentPersonalFile, &entry_table[0], 16 },
/*      5 */ { { &subid_table[130], 12 }, STRING, NULL, READ_FLAG | WRITE_FLAG, set_agentConfigFile, &entry_table[0], 24 },
/*      6 */ { { &subid_table[142], 12 }, STRING, NULL, READ_FLAG | WRITE_FLAG, set_agentExecutable, &entry_table[0], 32 },
/*      7 */ { { &subid_table[154], 12 }, STRING, NULL, READ_FLAG | WRITE_FLAG, set_agentVersionNum, &entry_table[0], 40 },
/*      8 */ { { &subid_table[166], 12 }, INTEGER, NULL, READ_FLAG | WRITE_FLAG, set_agentProcessID, &entry_table[0], 48 },
/*      9 */ { { &subid_table[178], 12 }, STRING, NULL, READ_FLAG | WRITE_FLAG, set_agentName, &entry_table[0], 52 },
/*     10 */ { { &subid_table[190], 12 }, TIMETICKS, NULL, READ_FLAG | WRITE_FLAG, set_agentSystemUpTime, &entry_table[0], 60 },
/*     11 */ { { &subid_table[202], 12 }, INTEGER, NULL, READ_FLAG | WRITE_FLAG, set_agentWatchDogTime, &entry_table[0], 64 },
/*     12 */ { { &subid_table[224], 12 }, INTEGER, NULL, READ_FLAG, NULL, &entry_table[1], 0 },
/*     13 */ { { &subid_table[236], 12 }, INTEGER, NULL, READ_FLAG, NULL, &entry_table[1], 4 },
/*     14 */ { { &subid_table[248], 12 }, OBJID, NULL, READ_FLAG | WRITE_FLAG, set_regTblOID, &entry_table[1], 8 },
/*     15 */ { { &subid_table[260], 12 }, INTEGER, NULL, READ_FLAG | WRITE_FLAG, set_regTblStartColumn, &entry_table[1], 16 },
/*     16 */ { { &subid_table[272], 12 }, INTEGER, NULL, READ_FLAG | WRITE_FLAG, set_regTblEndColumn, &entry_table[1], 20 },
/*     17 */ { { &subid_table[284], 12 }, INTEGER, NULL, READ_FLAG | WRITE_FLAG, set_regTblStartRow, &entry_table[1], 24 },
/*     18 */ { { &subid_table[296], 12 }, INTEGER, NULL, READ_FLAG | WRITE_FLAG, set_regTblEndRow, &entry_table[1], 28 },
/*     19 */ { { &subid_table[308], 12 }, INTEGER, &enum_table[5], READ_FLAG | WRITE_FLAG, set_regTblStatus, &entry_table[1], 32 },
/*     20 */ { { &subid_table[330], 12 }, INTEGER, NULL, READ_FLAG, NULL, &entry_table[2], 0 },
/*     21 */ { { &subid_table[342], 12 }, INTEGER, NULL, READ_FLAG, NULL, &entry_table[2], 4 },
/*     22 */ { { &subid_table[354], 12 }, OBJID, NULL, READ_FLAG | WRITE_FLAG, set_regTreeOID, &entry_table[2], 8 },
/*     23 */ { { &subid_table[366], 12 }, INTEGER, &enum_table[7], READ_FLAG | WRITE_FLAG, set_regTreeStatus, &entry_table[2], 16 },
