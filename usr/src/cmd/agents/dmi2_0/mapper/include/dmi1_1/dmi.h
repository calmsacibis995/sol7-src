...
*/
#pragma ident  "@(#)dmi.h	1.1 96/08/05 Sun Microsystems"
...
/* 6.5 DmiRegisterCiInd,   DmiRegisterCiCnf, DmiUnregisterCiInd */
...
#define alignmem(y) ((y+3)/4*4)
#define OFFSET_CONST 4
