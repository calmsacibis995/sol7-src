...
## Group and Table Declarations
	...
	(
		...
		characteristics "-N a2Index -O 1.3.6.1.4.1.42.2000.1.1.1.2.1.10 -T INTEGER -A RO -X equal -F 0"

		readwrite string[128]	a2Name
		description 	"Name of the developer."
		characteristics "-N a2Name -O 1.3.6.1.4.1.42.2000.1.1.1.2.1.20 -T STRING -A RW -X equal -F 0"

		readwrite string[128]	a2Company
		description 	"Corporation that this developer works for."
		characteristics "-N a2Company -O 1.3.6.1.4.1.42.2000.1.1.1.2.1.30 -T STRING -A RW -X equal -F 0"

		readwrite string[128]	a2OperatingSystemEnv
		description 	"The Operating system or Environment that this developer built
code for."
		characteristics "-N a2OperatingSystemEnv -O 1.3.6.1.4.1.42.2000.1.1.1.2.1.40 -T STRING -A RW -X equal -F 0"
	...
	(
		...
		characteristics "-N a42ProductName -O 1.3.6.1.4.1.42.2000.1.1.1.42.1.1 -T STRING -A RO -X equal -F 0"

		readonly string[128]	a42ProductVersion
		description 	"The product's version number"
		characteristics "-N a42ProductVersion -O 1.3.6.1.4.1.42.2000.1.1.1.42.1.2 -T STRING -A RO -X equal -F 0"
