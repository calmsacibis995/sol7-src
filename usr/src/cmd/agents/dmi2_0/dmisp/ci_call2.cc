// Copyright 08/21/96 Sun Microsystems, Inc. All Rights Reserved.
//
#pragma ident  "@(#)ci_callbacks.cc	1.11 96/08/21 Sun Microsystems"
...
CiSetAttribute(CiSetAttributeIN *argp, DmiErrorStatus_t *result)
{
	...
	switch (argp->attributeId){
        ...
        case 40:  /*Platform*/
            ...
            break;
        default:    /* this is not an attribute ID we understand */
			*result = DMIERR_ATTRIBUTE_NOT_FOUND;
			return; 
    }
