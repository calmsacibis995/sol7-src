...
#pragma ident  "@(#)encode.h	2.16 96/07/25 Sun Microsystems"
#endif
...
#if !defined(NO_PP)
typedef ALENGTH_T (*EHELPER_T)(EBUFFER_T *, OCTET_T *, ALENGTH_T);
...
extern	void		A_EncodeType(ATVALUE_T, OCTET_T, EHELPER_T, OCTET_T *);
extern	void		A_EncodeLength(ALENGTH_T, EHELPER_T, OCTET_T *);
