...
#pragma ident  "@(#)mib2.h	1.7 96/07/25 Sun Microsystems"
#endif
 ...
 *
 * Following def's used to get unique "level" for T_OPTMGMT_REQ.
 * Assumes values > IPPROTO_MAX and < SOL_SOCKET exist and are
