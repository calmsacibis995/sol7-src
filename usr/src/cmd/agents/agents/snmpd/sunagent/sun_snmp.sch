...
##pragma ident  "@(#)sun-snmp.schema	2.16 96/07/23 Sun Microsystems"
...
## Group and Table Declarations
	...
	(
		...
		readonly string[255]	sysName
		description 	"An administratively-assigned name for this
                      managed node.  By convention, this is the node's
                      fully-qualified domain name."
		characteristics "-N sysName -O 1.3.6.1.2.1.1.5 -T STRING -A RO -X equal -F 0"
	...
	(
		...
		readwrite octet[128]	atPhysAddress
		...
		characteristics "-N atPhysAddress -O 1.3.6.1.2.1.3.1.1.2 -T STRING -A RW -X equal -F 0"
	...
	characteristics "-K NONE"
	(
		readwrite enum ipForwardingE	ipForwarding
		description 	"The indication of whether this entity is acting
                      ...
                      inappropriate value."
		characteristics "-N ipForwarding -O 1.3.6.1.2.1.4.1 -T INTEGER -A RW -X equal -F 0"
	...
	characteristics "-K FOUR"
	(
		readwrite netaddress	ipRouteDest
		...
		characteristics "-N ipRouteDest -O 1.3.6.1.2.1.4.21.1.1 -T IPADDRESS -A RW -X equal -F 0"

		readwrite int	ipRouteIfIndex
		description 	"The index value which uniquely identifies the
                      ...
                      interface as identified by the same value of
                      ifIndex."
		characteristics "-N ipRouteIfIndex -O 1.3.6.1.2.1.4.21.1.2 -T INTEGER -A RW -X equal -F 0"

		readwrite int	ipRouteMetric1
		description 	"The primary routing metric for this route.  The
                      semantics of this metric are determined by the
                      routing-protocol specified in the route's
                      ipRouteProto value.  If this metric is not used,
                      its value should be set to -1."
		characteristics "-N ipRouteMetric1 -O 1.3.6.1.2.1.4.21.1.3 -T INTEGER -A RW -X equal -F 0"

		readwrite int	ipRouteMetric2
		description 	"An alternate routing metric for this route.  The
                      semantics of this metric are determined by the
                      routing-protocol specified in the route's
                      ipRouteProto value.  If this metric is not used,
                      its value should be set to -1."
		characteristics "-N ipRouteMetric2 -O 1.3.6.1.2.1.4.21.1.4 -T INTEGER -A RW -X equal -F 0"

		readwrite int	ipRouteMetric3
		description 	"An alternate routing metric for this route.  The
                      semantics of this metric are determined by the
                      routing-protocol specified in the route's
                      ipRouteProto value.  If this metric is not used,
                      its value should be set to -1."
		characteristics "-N ipRouteMetric3 -O 1.3.6.1.2.1.4.21.1.5 -T INTEGER -A RW -X equal -F 0"

		readwrite int	ipRouteMetric4
		description 	"An alternate routing metric for this route.  The
                      semantics of this metric are determined by the
                      routing-protocol specified in the route's
                      ipRouteProto value.  If this metric is not used,
                      its value should be set to -1."
		characteristics "-N ipRouteMetric4 -O 1.3.6.1.2.1.4.21.1.6 -T INTEGER -A RW -X equal -F 0"

		readwrite netaddress	ipRouteNextHop
		description 	"The IP address of the next hop of this route.
                      (In the case of a route bound to an interface
                      which is realized via a broadcast media, the value
                      of this field is the agent's IP address on that
                      interface.)"
		characteristics "-N ipRouteNextHop -O 1.3.6.1.2.1.4.21.1.7 -T IPADDRESS -A RW -X equal -F 0"

		readwrite enum ipRouteTypeE	ipRouteType
		...
		characteristics "-N ipRouteType -O 1.3.6.1.2.1.4.21.1.8 -T INTEGER -A RW -X equal -F 0"
		...
		readwrite int	ipRouteAge
		description 	"The number of seconds since this route was last
                      updated or otherwise determined to be correct.
                      Note that no semantics of `too old' can be implied
                      except through knowledge of the routing protocol
                      by which the route was learned."
		characteristics "-N ipRouteAge -O 1.3.6.1.2.1.4.21.1.10 -T INTEGER -A RW -X equal -F 0"

		readwrite netaddress	ipRouteMask
		...
		characteristics "-N ipRouteMask -O 1.3.6.1.2.1.4.21.1.11 -T IPADDRESS -A RW -X equal -F 0"

		readwrite int	ipRouteMetric5
		description 	"An alternate routing metric for this route.  The
                      semantics of this metric are determined by the
                      routing-protocol specified in the route's
                      ipRouteProto value.  If this metric is not used,
                      its value should be set to -1."
		characteristics "-N ipRouteMetric5 -O 1.3.6.1.2.1.4.21.1.12 -T INTEGER -A RW -X equal -F 0"
	...
	(
		readonly int	ipNetToMediaIfIndex
		description 	"The interface on which this entry's equivalence
                      is effective.  The interface identified by a
                      particular value of this index is the same
                      interface as identified by the same value of
                      ifIndex."
		characteristics "-N ipNetToMediaIfIndex -O 1.3.6.1.2.1.4.22.1.1 -T INTEGER -A RO -X equal -F 0"
		...
		readonly netaddress	ipNetToMediaNetAddress
		description 	"The IpAddress corresponding to the media-
                      dependent `physical' address."
		characteristics "-N ipNetToMediaNetAddress -O 1.3.6.1.2.1.4.22.1.3 -T IPADDRESS -A RO -X equal -F 0"
	...
	(
		readwrite enum tcpConnStateE	tcpConnState
		...
		characteristics "-N tcpConnState -O 1.3.6.1.2.1.6.13.1.1 -T INTEGER -A RW -X equal -F 0"
...
## Group and Table Declarations
	...
	characteristics "-K NONE"
	(
		readonly string[255]	agentDescr
		description 	"The SNMP agent's description of itself."
		characteristics "-N agentDescr -O 1.3.6.1.4.1.42.3.1.1 -T STRING -A RO -X equal -F 0"

		readonly octet[4]	hostID
		description 	"The unique Sun hardware identifier.
			The value returned is four byte binary
			string."
		characteristics "-N hostID -O 1.3.6.1.4.1.42.3.1.2 -T STRING -A RO -X equal -F 0"

		readonly string[255]	motd
		description 	"The first line of /etc/motd."
		characteristics "-N motd -O 1.3.6.1.4.1.42.3.1.3 -T STRING -A RO -X equal -F 0"

		readonly counter	unixTime
		description 	"The Unix system time.  Measured in seconds
			since January 1, 1970 GMT."
		characteristics "-N unixTime -O 1.3.6.1.4.1.42.3.1.4 -T COUNTER -A RO -X equal -F 0"

	)

	table	sunProcessTable
	description "(null)"
	characteristics "-K ONE"
	(
		readonly int	psProcessID
		description 	"The process identifier for this process."
		characteristics "-N psProcessID -O 1.3.6.1.4.1.42.3.12.1.1.1 -T INTEGER -A RO -X equal -F 0"

		readonly int	psParentProcessID
		description 	"The process identifier of this process's parent."
		characteristics "-N psParentProcessID -O 1.3.6.1.4.1.42.3.12.1.1.2 -T INTEGER -A RO -X equal -F 0"

		readonly int	psProcessSize
		description 	"The combined size of the data and stack segments
			(in kilobytes.)"
		characteristics "-N psProcessSize -O 1.3.6.1.4.1.42.3.12.1.1.3 -T INTEGER -A RO -X equal -F 0"

		readonly int	psProcessCpuTime
		description 	"The CPU time (including both user and system
			time) consumed so far."
		characteristics "-N psProcessCpuTime -O 1.3.6.1.4.1.42.3.12.1.1.4 -T INTEGER -A RO -X equal -F 0"

		readonly string[4]	psProcessState
		description 	"The run-state of the process.
			R - Runnable
			T - Stopped
			P - In page wait
			...
			Z - Zombie"
		characteristics "-N psProcessState -O 1.3.6.1.4.1.42.3.12.1.1.5 -T STRING -A RO -X equal -F 0"

		readonly string[16]	psProcessWaitChannel
		description 	"Reason process is waiting."
		characteristics "-N psProcessWaitChannel -O 1.3.6.1.4.1.42.3.12.1.1.6 -T STRING -A RO -X equal -F 0"

		readonly string[16]	psProcessTTY
		description 	"Terminal, if any, controlling this process."
		characteristics "-N psProcessTTY -O 1.3.6.1.4.1.42.3.12.1.1.7 -T STRING -A RO -X equal -F 0"

		readonly string[16]	psProcessUserName
		description 	"Name of the user associated with this process."
		characteristics "-N psProcessUserName -O 1.3.6.1.4.1.42.3.12.1.1.8 -T STRING -A RO -X equal -F 0"

		readonly int	psProcessUserID
		description 	"Numeric form of the name of the user associated
			with this process."
		characteristics "-N psProcessUserID -O 1.3.6.1.4.1.42.3.12.1.1.9 -T INTEGER -A RO -X equal -F 0"

		readonly string[64]	psProcessName
		description 	"Command name used to invoke this process."
		characteristics "-N psProcessName -O 1.3.6.1.4.1.42.3.12.1.1.10 -T STRING -A RO -X equal -F 0"

		readwrite int	psProcessStatus
		description 	"Setting this variable will cause a signal
			of the set value to be sent to the process."
		characteristics "-N psProcessStatus -O 1.3.6.1.4.1.42.3.12.1.1.11 -T INTEGER -A RW -X equal -F 0"
	...
	characteristics "-K NONE"
	(
		readonly counter	rsUserProcessTime
		description 	"total number of timeticks used by user processes
			since the system was last booted."
		characteristics "-N rsUserProcessTime -O 1.3.6.1.4.1.42.3.13.1 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsNiceModeTime
		description 	"total number of timeticks used by nice mode since
			the system was last booted."
		characteristics "-N rsNiceModeTime -O 1.3.6.1.4.1.42.3.13.2 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsSystemProcessTime
		description 	"total number of timeticks used by system processes
			since the system was last booted."
		characteristics "-N rsSystemProcessTime -O 1.3.6.1.4.1.42.3.13.3 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsIdleModeTime
		description 	"total number of timeticks used in idle mode since
			the system was last booted."
		characteristics "-N rsIdleModeTime -O 1.3.6.1.4.1.42.3.13.4 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsDiskXfer1
		description 	""
		characteristics "-N rsDiskXfer1 -O 1.3.6.1.4.1.42.3.13.5 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsDiskXfer2
		description 	""
		characteristics "-N rsDiskXfer2 -O 1.3.6.1.4.1.42.3.13.6 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsDiskXfer3
		description 	""
		characteristics "-N rsDiskXfer3 -O 1.3.6.1.4.1.42.3.13.7 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsDiskXfer4
		description 	""
		characteristics "-N rsDiskXfer4 -O 1.3.6.1.4.1.42.3.13.8 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsVPagesIn
		description 	"Number of pages read in from disk."
		characteristics "-N rsVPagesIn -O 1.3.6.1.4.1.42.3.13.9 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsVPagesOut
		description 	"Number of pages written to disk."
		characteristics "-N rsVPagesOut -O 1.3.6.1.4.1.42.3.13.10 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsVSwapIn
		description 	"Number of pages swapped in."
		characteristics "-N rsVSwapIn -O 1.3.6.1.4.1.42.3.13.11 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsVSwapOut
		description 	"Number of pages swapped out."
		characteristics "-N rsVSwapOut -O 1.3.6.1.4.1.42.3.13.12 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsVIntr
		description 	"Number of device interrupts."
		characteristics "-N rsVIntr -O 1.3.6.1.4.1.42.3.13.13 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsIfInPackets
		description 	"Number of input packets."
		characteristics "-N rsIfInPackets -O 1.3.6.1.4.1.42.3.13.14 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsIfOutPackets
		description 	"Number of output packets."
		characteristics "-N rsIfOutPackets -O 1.3.6.1.4.1.42.3.13.15 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsIfInErrors
		description 	"Number of input errors."
		characteristics "-N rsIfInErrors -O 1.3.6.1.4.1.42.3.13.16 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsIfOutErrors
		description 	"Number of output errors."
		characteristics "-N rsIfOutErrors -O 1.3.6.1.4.1.42.3.13.17 -T COUNTER -A RO -X equal -F 0"

		readonly counter	rsIfCollisions
		description 	"Number of output collisions."
		characteristics "-N rsIfCollisions -O 1.3.6.1.4.1.42.3.13.18 -T COUNTER -A RO -X equal -F 0"
