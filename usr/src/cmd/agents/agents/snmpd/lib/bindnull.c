...
#ifdef SVR4
#pragma ident  "@(#)bindnull.c	2.15 96/07/23 Sun Microsystems"
#else
static char sccsid[] = "@(#)bindnull.c	2.15 96/07/23 Sun Microsystems";
#endif
#endif
...
/* $Header:   E:/SNMPV2/SNMP/BINDNULL.C_V   2.0   31 Mar 1990 15:06:36  $	*/
/*
 * $Log:   E:/SNMPV2/SNMP/BINDNULL.C_V  $
 * 
...
PURPOSE:  Bind a Null into a VarBindList
...
#else	/* NO_PP */
int
SNMP_Bind_Null(pktp, indx, compc, compl)
	SNMP_PKT_T	*pktp;
	int		indx;
	int		compc;
	OIDC_T		*compl;
