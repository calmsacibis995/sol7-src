...
#ifdef SVR4
#pragma ident  "@(#)bindip.c	2.15 96/07/23 Sun Microsystems"
#else
static char sccsid[] = "@(#)bindip.c	2.15 96/07/23 Sun Microsystems";
#endif
#endif
...
/* $Header:   E:/SNMPV2/SNMP/BINDIP.C_V   2.0   31 Mar 1990 15:06:36  $	*/
/*
 * $Log:   E:/SNMPV2/SNMP/BINDIP.C_V  $
 * 
...
/****************************************************************************
NAME:  SNMP_Bind_IP_Address

PURPOSE:  Bind an IP Address
...
PARAMETERS:
	...
	OCTET_T *	Pointer to a four byte field containing the IP
...
#else	/* NO_PP */
int
SNMP_Bind_IP_Address(pktp, indx, compc, compl, ipp)
	SNMP_PKT_T	*pktp;
	int		indx;
	int		compc;
	OIDC_T		*compl;
...
(void) memcpy(vbp->value_u.v_network_address, ipp, 4);
return 0;
}
