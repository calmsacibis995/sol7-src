#pragma ident	"@(#)EUCJPCodingSystem.cxx	1.2	97/04/24 SMI"
...
// jsa, 4/14/97  this method added to kill SPRO warnings.  directly copied from above
void EUCJPEncoder::output(Char *s, size_t n, streambuf *sb)
{
  for (; n > 0; s++, n--) {
    Char c = *s;
    unsigned short mask = (unsigned short)(c & 0x8080);
