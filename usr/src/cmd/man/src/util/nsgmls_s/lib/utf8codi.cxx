#pragma ident	"@(#)UTF8CodingSystem.cxx	1.2	97/04/24 SMI"
...
// jsa, 4/14/97  this method added to kill SPRO warnings.  copied directly from above
void UTF8Encoder::output(Char *s, size_t n, streambuf *sb)
{
  for (; n > 0; s++, n--) {
    Char c = *s;
    if (c < min2)
