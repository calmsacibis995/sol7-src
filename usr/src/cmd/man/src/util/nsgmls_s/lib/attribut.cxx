#pragma ident	"@(#)Attribute.cxx	1.2	97/04/24 SMI"
					      ...
					      unsigned &specLength) const
{
  ...
  size_t normalizedLength = text.size() + (normsep
...
{
// jsa, 4/14/97
  TokenizedAttributeValue *val = makeTokenizedValue(text, context, name_nohide,
						    specLength);
  if (!val)
    return 0;
