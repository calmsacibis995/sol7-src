...
#pragma ident	"@(#)automount.h	1.40	97/10/20 SMI"
 ...
 */
extern int add_mnttab(struct mnttab *, dev_t devid);
extern void fix_mnttab(struct mnttab *);
extern void del_mnttab(struct mnttab *);
extern void free_mapent(struct mapent *);
extern struct mntlist *getmntlist(void);
extern dev_t get_devid(struct mnttab *);
extern int postunmount_remove_mnttab(struct postumntreq *);
...
extern int nopt(struct mnttab *, char *);
...
extern int do_mount1(char *, char *, char *, char *, char *, u_int,
	action_list **, struct authunix_parms *);
extern int do_lookup1(char *, char *, char *, char *, char *, u_int,
	enum autofs_action *, struct linka *, struct authunix_parms *);
extern int do_unmount1(umntrequest *);
extern int postmount(postmountreq *);
extern int postunmount(postumntreq *);
