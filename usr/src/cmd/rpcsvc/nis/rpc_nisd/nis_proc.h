/*
 * SCCSID  = "@(#)nis_proc.h	1.9 92/05/15   Copyright 1990 SMI"
 *
 *	nis_proc.h
 *
...
#pragma ident	"@(#)nis_proc.h	1.16	96/12/17 SMI"
...
extern nis_error 	__db_addib_nolog(nis_name, int, nis_attr *, nis_object *);
