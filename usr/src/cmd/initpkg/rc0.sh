...
# All rights reserved.
#
#ident	"@(#)rc0.sh	1.18	98/02/03 SMI"
...
export _INIT_RUN_LEVEL _INIT_RUN_NPREV _INIT_PREV_LEVEL \
    _INIT_UTS_NODENAME _INIT_UTS_RELEASE _INIT_UTS_VERSION \
...
# because they are mounted by rcS (for single user mode) rather than mountall.
