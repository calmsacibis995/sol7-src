...
#pragma	ident	"@(#)audio_clean.c	1.11	97/11/25 SMI"
...
#ifdef BUGID4053328
		/* hack to avoid bugid 4053328: audio driver CS4231
		   AUDIO_SETINFO ioctl command alwais sets EINVAL
		   when there is no audio flow */
		if (errno != EINVAL) {
#endif
		{
