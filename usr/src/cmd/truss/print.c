...
#pragma ident	"@(#)print.c	1.30	97/12/23 SMI"	/* SVr4.0 1.9	*/
 ...
 */
static	void	prt_nov(int, long);
static	void	prt_dec(int, long);
static	void	prt_uns(int, long);
static	void	prt_oct(int, long);
static	void	prt_hex(int, long);
static	void	prt_hhx(int, long);
static	void	prt_dex(int, long);
static	void	prt_stg(int, long);
static	void	prt_rst(int, long);
static	void	prt_rlk(int, long);
static	void	prt_ioc(int, long);
static	void	prt_ioa(int, long);
static	void	prt_fcn(int, long);
static	void	prt_s86(int, long);
static	void	prt_uts(int, long);
static	void	prt_msc(int, long);
static	void	prt_msf(int, long);
static	void	prt_smc(int, long);
static	void	prt_sef(int, long);
static	void	prt_shc(int, long);
static	void	prt_shf(int, long);
static	void	prt_sfs(int, long);
static	void	prt_opn(int, long);
static	void	prt_sig(int, long);
static	void	prt_six(int, long);
static	void	prt_act(int, long);
static	void	prt_smf(int, long);
static	void	prt_plk(int, long);
static	void	prt_mtf(int, long);
static	void	prt_mft(int, long);
static	void	prt_iob(int, long);
static	void	prt_wop(int, long);
static	void	prt_spm(int, long);
static	void	prt_mpr(int, long);
static	void	prt_mty(int, long);
static	void	prt_mcf(int, long);
static	void	prt_mc4(int, long);
static	void	prt_mc5(int, long);
static	void	prt_mad(int, long);
static	void	prt_ulm(int, long);
static	void	prt_rlm(int, long);
static	void	prt_cnf(int, long);
static	void	prt_inf(int, long);
static	void	prt_ptc(int, long);
static	void	prt_fui(int, long);
static	void	prt_idt(int, long);
static	void	prt_lwf(int, long);
static	void	prt_itm(int, long);
static	void	prt_vtr(int, long);
static	void	prt_mod(int, long);
static	void	prt_whn(int, long);
static	void	prt_acl(int, long);
static	void	prt_aio(int, long);
static	void	prt_aud(int, long);
static	void	prt_llo(int, long, long);
static	void	grow(int);
static	const char *mmap_protect(long);
static	const char *mmap_type(long);
...
prt_ioa(int raw, long val)	/* print ioctl argument */
{
	...
	case KSTAT_IOC_WRITE:
		...
		if (data_model == PR_MODEL_ILP32)
			prt_stg(raw, val + offsetof(kstat32_t, ks_name));
		else
#endif
			prt_stg(raw, val + offsetof(kstat_t, ks_name));
		break;
