...
#pragma ident	"@(#)proto.h	1.19	98/02/17 SMI"	/* SVr4.0 1.6	*/
...
extern	const char *svfsflags(u_long);
...
extern	void	timestamp(pstatus_t *);
...
extern	void	establish_breakpoints(struct ps_prochandle *, int);
