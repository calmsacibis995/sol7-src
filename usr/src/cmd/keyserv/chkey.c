 ...
 *	chkey.c
 *
 *	Copyright (c) 1997 Sun Microsystems, In.c
 *	All Rights Reserved.
 */

#pragma ident	"@(#)chkey.c	1.22	98/01/23 SMI"
...
extern int localupdate(char *, char *, u_int, char *);
extern int xencrypt();
...
usage()
{
	fprintf(stderr, "usage: %s [-p] [-s nisplus | nis | files] \n",
		program_name);
	exit(1);
}
