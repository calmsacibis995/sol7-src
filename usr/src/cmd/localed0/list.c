 ...
 * All rights reserved.
 */
#pragma	ident	"@(#)list.c 1.5	97/07/25  SMI"
...
static char rcsid[] = "@(#)$RCSfile: list.c,v $ $Revision: 1.3.2.3 $"
	" (OSF) $Date: 1992/02/18 20:25:16 $";
#endif
/*
...
*/
list_t *
create_list(int (*comparator)(void *, void *))
{
	list_t *l;
