 ...
 * All rights reserved.
 */
#pragma	ident	"@(#)init.c 1.27	97/11/10  SMI"
 ...
 * CHARMAP
 */
_LC_methods_charmap_t charmap_methods = {
 ...
 * COLLATE
 */
_LC_methods_collate_t methods_collate = {
 ...
 * CTYPE
 */
_LC_methods_ctype_t methods_ctype = {
 ...
 * MONETARY
 */
_LC_methods_monetary_t methods_monetary = {
 ...
 * NUMERIC
 */
_LC_methods_numeric_t methods_numeric = {
...
_LC_methods_time_t methods_time = {
 ...
 * MESSAGES
 */
_LC_methods_messages_t methods_messages = {
	(short) 6,		/* total number of methods */
	(short) 1,		/* used  number of methods */
	NULLF,
	{ PLACEHOLDER, PLACEHOLDER, PLACEHOLDER, PLACEHOLDER, PLACEHOLDER }
...
_LC_methods_locale_t methods_locale = {
	(short) 7,		/* total number of methods */
	(short) 2,		/* used  number of methods */
	NULLF,
	NULLF,
...
init_symbol_tbl(int seed)
{
	...
	/* craigm - needs work - add to symbol table */
