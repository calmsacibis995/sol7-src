 ...
 * All rights reserved.
 */
#pragma	ident	"@(#)iso_8859_1.c 1.6	97/11/10  SMI"

#include <locale.h>
#include <sys/localedef.h>

extern int __mbftowc_euc(_LC_charmap_t*, char*, wchar_t*, int (*)(), int *);
...
extern int __wcwidth_euc(_LC_charmap_t*, const wchar_t);
extern int __fnmatch_sb(_LC_collate_t*, const char*,const char*,const char*,int);
extern int __regcomp_std(_LC_collate_t*, regex_t*,const char*,int);
extern size_t __regerror_std(_LC_collate_t*, int,const regex_t*,char*,size_t);
extern int __regexec_std(_LC_collate_t*, const regex_t*,const char*,size_t,regmatch_t*,int);
...
extern size_t __wcsxfrm_std(_LC_collate_t*, wchar_t*,const wchar_t*,size_t);
...
extern struct lconv *__localeconv_std();
extern char *__nl_langinfo_std();
extern _LC_monetary_t *__monetary_init(_LC_locale_t*);
extern ssize_t __strfmon_std(_LC_monetary_t*, char*,size_t,const char *,va_list);
...
extern size_t __strftime_std(_LC_time_t*, char*,size_t,const char*,const struct tm*);
extern char * __strptime_std(_LC_time_t*, const char*,const char*,struct tm*);
extern size_t __wcsftime_std(_LC_time_t*, wchar_t*,size_t,const char*,const struct tm*);
...
extern int __mbftowc_sb(_LC_charmap_t*, char*, wchar_t*, int (*)(), int *);
...
extern size_t __mbrtowc_euc(_LC_charmap_t *, wchar_t *, const char *, size_t, mbstate_t *);
extern size_t __wcrtomb_euc(_LC_charmap_t *, char *, wchar_t, mbstate_t *);
extern size_t __mbsrtowcs_euc(_LC_charmap_t *, wchar_t *, const char **, size_t, mbstate_t *);
extern size_t __wcsrtombs_euc(_LC_charmap_t *, char *, const wchar_t **, size_t, mbstate_t *);
extern wint_t __btowc_sb(_LC_charmap_t *, int);
extern int __wctob_sb(_LC_charmap_t *, wint_t);
extern size_t __mbrtowc_sb(_LC_charmap_t *, wchar_t *, const char *, size_t, mbstate_t *);
extern size_t __wcrtomb_sb(_LC_charmap_t *, char *, wchar_t, mbstate_t *);
extern size_t __mbsrtowcs_sb(_LC_charmap_t *, wchar_t *, const char **, size_t, mbstate_t *);
extern size_t __wcsrtombs_sb(_LC_charmap_t *, char *, const wchar_t **, size_t, mbstate_t *);
/*------------------------------EUC INFO-----------------------------*/
static _LC_euc_info_t cm_eucinfo={
	(char) 1,
	(char) 1,
	(char) 0,
	(char) 0,
...
/*------------------------- CHARMAP OBJECT  -------------------------*/
static _LC_methods_charmap_t native_methods_charmap={
	(short) 0,
	(short) 0,
	(char *(*) ()) 0,
	__mbtowc_sb,
...
static _LC_charmap_t lc_cmap = {{
	{3, _LC_MAGIC, _LC_VERSION_MAJOR, _LC_VERSION_MINOR, 72},
	__charmap_init,
	0,				/* charmap_destructor() */
	&user_methods_charmap,
	&native_methods_charmap,
	__eucpctowc_gen,
	__wctoeucpc_gen,
	(void *)0,
	},	/* End core */
...
0x00000020, 0x00000020, 0x00000020, 0x00000020, 
0x00000020, 0x00000028, 0x00000028, 0x00000028, 
...
/*-------------------------   CTYPE OBJECT   -------------------------*/
static _LC_methods_ctype_t native_methods_ctype={
	(short) 0,
	(short) 0,
	__wctype_std,
	__iswctype_sb,
...
static _LC_ctype_t lc_ctype = {{
	{4, _LC_MAGIC, _LC_VERSION_MAJOR, _LC_VERSION_MINOR, 140},
	__ctype_init,
	0,				/* ctype_destructor() */
	&user_methods_ctype,
	&native_methods_ctype,
	(void *)0,
	},	/* End core */
	&lc_cmap,
	0,
...
/*-------------------------- LOCALE OBJECT --------------------------*/
static _LC_methods_locale_t native_methods_locale={
	(short) 0,
	(short) 0,
	__nl_langinfo_std,
	__localeconv_std,
...
static _LC_locale_t lc_loc={{
	{2, _LC_MAGIC, _LC_VERSION_MAJOR, _LC_VERSION_MINOR, 308},
	__locale_init,
	0,				/* locale_destructor() */
	&native_methods_locale,
	&native_methods_locale,
	(void *)0,
	},	/* End core */
	(void *)0,
	...
	(void *)0,
	59,
	{  /* nl_langinfo[] filled in at setlocale() time */
	(void *)0,
	(void *)0,
	(void *)0,
	(void *)0,
