...
#pragma ident "@(#)diskhdr.h 1.5     97/05/19 SMI"
...
struct disk {
	...
	char *devfsdsknm;	/* bus address  between @ and : */
	char *devdrvnm;	/* name of driver.  ex. sd, ssd, etc */
	struct {
		char *devfspart;	/* Block & Raw devfs partition */
		short  state;		/* State of link: valid, invalid */
					/* or missing */
	} part[MAXPART][2];
    /*
