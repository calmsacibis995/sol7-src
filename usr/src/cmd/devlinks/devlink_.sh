...
# All rights reserved.
#
#ident	"@(#)devlink.tab.sh	1.66	98/01/20 SMI"
#
...
cat <<EOM
#ident "@(#)devlink.tab	1.66	98/01/20 SMI"
#
...
type=ddi_pseudo;name=lockstat	\M0
...
case "$MACH" in
  "i386" ) 
	...
	type=ddi_serial:mb;	tty\M0
	type=ddi_serial:dialout,mb;minor=a,cu	cua0
	type=ddi_serial:dialout,mb;minor=b,cu	cua1
	type=ddi_serial:dialout,mb;minor=c,cu	cua2
	type=ddi_serial:dialout,mb;minor=d,cu	cua3
