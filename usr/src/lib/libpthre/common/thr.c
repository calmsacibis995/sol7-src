...
#pragma ident	"@(#)thr.c	1.7	97/03/13 SMI"
...
/*
 * The symbols thr_probe_setup, thr_probe_getfunc_addr, _resume_ret and
 * _resume don't have a pragma weak associated with them because they
 * are not exported as weak by libthread
 */
/* ARGSUSED */
void
