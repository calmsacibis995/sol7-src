...
#ident	"@(#)ptrace.c	1.5	97/08/08 SMI"
...
{
	char procname[32];		/* /proc/nnnnn/fname */
	char *fname;
	int fd;
	int omode;
...
{
	char procname[32];	/* /proc/<pid>/psinfo */
	int fd;
...
{
	char procname[32];	/* /proc/<pid>/sigact */
	int fd;
