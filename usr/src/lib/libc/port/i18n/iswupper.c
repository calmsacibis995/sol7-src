...
#pragma ident	"@(#)iswupper.c 1.7	96/12/20 SMI"
...
static char rcsid[] = "@(#)$RCSfile: iswupper.c,v $ "
"$Revision: 1.3.2.6 $ (OSF) $Date: 1992/03/17 02:12:15 $";
#endif
*/
/*
...
_iswupper(wint_t pc)
{
	return (METHOD(__lc_ctype, iswctype)(__lc_ctype, pc, _ISUPPER));
}
