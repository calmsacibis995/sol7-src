...
#pragma	ident	"@(#)ispunct.c 1.6	96/11/22  SMI"
...
static char rcsid[] = "@(#)$RCSfile: ispunct.c,v $ "
"$Revision: 1.6.2.6 $ (OSF) $Date: 1992/03/17 02:11:24 $";
#endif
*/
/*
...
ispunct(int c)
{
	...
	if ((c >= 0) && (c < 256))
		return (__lc_ctype->mask[c] & _ISPUNCT);
	else
		return (0);
