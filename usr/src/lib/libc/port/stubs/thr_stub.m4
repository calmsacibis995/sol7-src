...
#pragma	ident	"@(#)thr_stub.m4	1.22	98/01/14 SMI"
...
DEFSTUB2(pthread_attr_getschedparam, TI_PATTR_GSPA, const pthread_attr_t *,
	struct sched_param *)
DEFSTUB3(pthread_attr_getschedpolicy, TI_PATTR_GSPO, )
...
DEFSTUB4(pthread_create, TI_PCREATE, pthread_t *, const pthread_attr_t *,
	 void *, void *)
DEFSTUB1(pthread_detach, TI_PDETACH, )
