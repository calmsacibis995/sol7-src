...
#pragma	ident	"@(#)__wctomb_dense_eucjp.c	1.7	97/09/23  SMI"

/*
static char sccsid[] = "@(#)56	1.3.1.1  "
"src/bos/usr/ccs/lib/libc/__wctomb_dense_eucjp.c, bos, bos410 5/25/92 13:44:25";
*/
/*
 * COMPONENT_NAME: (LIBCCCPPC) LIBC Code-Point/Process-Code Conversion Functions
 *
 * FUNCTIONS: __wctomb_dense_eucjp
 *
 * ORIGINS: 27
 *
...
int
__wctomb_dense_eucjp(_LC_charmap_t *handle, char *s, wchar_t pwc)
{
	/*
