...
#pragma	ident	"@(#)__mblen_dense_eucjp.c 1.7	97/09/23  SMI"

/*
 * static char sccsid[] = "@(#)39	1.4.1.1  src/bos/usr/ccs/lib/libc/"
 * "__mblen_dense_eucjp.c, bos, bos410 5/25/92 13:42:55";
 */
/*
 * COMPONENT_NAME: (LIBCCCPPC) LIBC Code-Point/Process-Code Conversion Functions
 *
 * FUNCTIONS: __mblen_dense_eucjp
 *
 * ORIGINS: 27
 *
...
int
__mblen_dense_eucjp(_LC_charmap_t *hdl, const char *ts, size_t maxlen)
{
