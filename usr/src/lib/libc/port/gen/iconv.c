...
#pragma ident  "@(#)iconv.c 1.12     97/07/31 SMI"
...
static	iconv_p iconv_open_private(const char *);
...
iconv_open_private(const char *lib)
{
	...
	if ((fptr = (iconv_t(*)(void))dlsym(cdpath->_icv_handle, "_icv_open"))
	    == NULL) {
