#ident	"@(#)tf_shm.c	1.3	97/11/25 SMI"
/*
...
"$Id: tf_shm.c,v 4.2 89/10/25 23:26:46 qjb Exp $";
#endif	lint
...
char *file_name;
{
    ...
    shmid = shmget((key_t)IPC_PRIVATE,MAX_BUFF, IPC_CREAT);
    if (shmid == -1) { 
	if (krb_debug)
