#ident	"@(#)create_auth_reply.c	1.3	97/11/25 SMI"
/*
...
"$Header: create_auth_reply.c,v 4.10 89/01/13 17:47:38 steiner Exp $";
#endif /* lint */
 ...
 * 
 * unsigned int	x_date		   expiration date
 * 
...
create_auth_reply(pname,pinst,prealm,time_ws,n,x_date,kvno,cipher)
    ...
    int time_ws;               /* Workstation time */
    int n;                      /* Number of tickets */
    unsigned int x_date;	/* Principal's expiration date */
