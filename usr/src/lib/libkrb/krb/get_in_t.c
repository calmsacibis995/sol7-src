#ident	"@(#)get_in_tkt.c	1.4	97/11/25 SMI"
/*
...
"$Header: get_in_tkt.c,v 4.12 89/07/18 16:32:56 jtkohl Exp $";
#endif /* lint */
...
static int passwd_to_key(user,instance,realm,passwd,key)
    ...
    C_Block key;
{
    extern int des_string_to_key(), des_read_password(), krb_get_in_tkt();
...
#include <stdio.h>
#if defined(BSDUNIX) || defined(SunOS)
#ifdef SYSV
#include <string.h>
#else
#include <strings.h>
