#ident	"@(#)mk_priv.c	1.3	97/11/25 SMI"
/*
...
"$Header: mk_priv.c,v 4.13 89/03/22 14:48:59 jtkohl Exp $";
#endif /* lint */
    ...
    struct sockaddr_in *receiver; /* receiver address */
{
    ...
    msg_time_sec = (int) msg_time.tv_sec;
    ...
    *p++ = AUTH_MSG_PRIVATE | HOST_BYTE_ORDER;
    ...
    pcbc_encrypt((C_Block *) q,(C_Block *) q, (int) (p-q), schedule,
                 key, ENCRYPT);
#endif /* NOENCRYPTION */
