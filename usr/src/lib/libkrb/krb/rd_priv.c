#ident	"@(#)rd_priv.c	1.3	97/11/25 SMI"
/*
...
int krb_rd_priv(in,in_length,schedule,key,sender,receiver,m_data)
    ...
    MSG_DAT *m_data;		/*various input/output data from msg */
{
    ...
    pcbc_encrypt((C_Block *) q,(C_Block *) q, (int) c_length,
    ...
    delta_t = abs((int)(local_time.tv_sec
			- m_data->time_sec));
