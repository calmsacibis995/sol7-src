#ident	"@(#)create_ticket.c	1.3	97/11/25 SMI"
/*
...
"$Header: create_ticket.c,v 4.11 89/03/22 14:43:23 jtkohl Exp $";
#endif /* lint */
...
int krb_create_ticket(tkt, flags, pname, pinstance, prealm, paddress,
    ...
    int    paddress;           /* Net address of requesting entity */
    char    *session;           /* Session key inserted in ticket */
    short   life;               /* Lifetime of the ticket */
    int    time_sec;           /* Issue time and date */
    ...
    C_Block key;                /* Service's secret key */
{
    ...
    extern int des_key_sched(), des_pcbc_encrypt();
