...
#pragma ident	"@(#)dhcdata.h	1.13	98/01/06 SMI"
...
extern int del_dd();
extern int stat_dd();
extern int add_dd_entry();
extern int mod_dd_entry();
extern int rm_dd_entry();
extern int check_dd_access();
extern int dd_ns();
extern void free_dd();
extern void free_dd_stat();
