...
#pragma ident	"@(#)getspent.c	1.13	97/08/12 SMI"
	...
	void			*a;
{
	 ...
	 * we return now.
	 *
	 * Currently this fix only works for single-threaded programs.
	 * We don't even attempt this if libthread is linked in.
	 */
