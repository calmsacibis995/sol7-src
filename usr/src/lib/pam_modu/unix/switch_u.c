...
#pragma	ident	"@(#)switch_utils.c	1.3	97/01/09 SMI"	/* PAM 2.6 */
	...
	int nowarn;
{
	...
	/*
	 * if old command (i.e. yppasswd or nispasswd), or if
	 * "-r <rep>" is specified, doesn't look at nsswitch file
	 */
	if ((o_rep != PAM_REP_DEFAULT))
		return (o_rep);
