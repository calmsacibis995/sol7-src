...
#pragma	ident   "@(#)i386subr.s 1.24     97/06/13     SMI"
 ...
 */
	ALTENTRY(_flush_and_tell)
	ENTRY(_getsp)
	leal	4(%esp), %eax	/ sp after pop of return address
	ret
	SET_SIZE(_getsp)
 ...
 */
	...
	fldenv	(%eax)
	pushl	$-1
	call	fcnref(_sc_setup)	/ if it is, call _sc_setup(-1)
	addl	$4, %esp
L1:	
