...
#pragma ident	"@(#)probe_cntl.c	1.30	98/01/21 SMI"
...
typedef void (*tnf_thr_exit_func_t)(void *);

typedef void (*tnf_pthread_exit_func_t)(void *);
...
thr_exit(void * status)
{
	...
	*
	* Addendum:
	* Now you can't get events for thr_exit using an interposition
	* library.  Since thr_exit is a really helpful event, this is a problem.
