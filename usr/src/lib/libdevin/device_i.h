...
#pragma ident	"@(#)device_info.h	1.7	98/01/06 SMI"
...
/*
 * search the devinfo property lists for int property "name" and
 * its value in prop_v.
 */
extern int devinfo_prop_get_int(dev_t dev, const dev_info_t *dip, char *name,
				int *prop_v);
