...
#pragma ident	"@(#)libaio.h	1.22	97/08/29 SMI"
...
extern int _aio_create_worker(struct aio_req *, int, int);
...
extern void _aio_work_done(struct aio_worker *);
extern void _aio_cancel_work(struct aio_req *, int);
extern void _aio_forkinit();
extern void _aiopanic(char *);
extern void _aio_lock(void);
extern void _aio_unlock(void);
extern void _aio_req_free(aio_req_t *);
extern struct aio_req *_aio_hash_del(aio_result_t *);
...
extern void _aio_req_add(struct aio_req *);
...
extern struct aio_worker *_nextworker_rd;  /* worker chosen for next request */
extern struct aio_worker *_workers_rd;	   /* list of all workers */
extern struct aio_worker *_nextworker_wr;  /* worker chosen for next request */
extern struct aio_worker *_workers_wr;	   /* list of all workers */
extern struct aio_worker *_nextworker_fs;  /* worker chosen for next request */
extern struct aio_worker *_workers_fs;  /* list of all workers */
