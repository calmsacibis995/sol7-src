...
#pragma ident	"@(#)pr_getrlimit.c	1.1	97/12/23 SMI"
 ...
 */
int
pr_getrlimit(struct ps_prochandle *Pr, int resource, struct rlimit *rlp)
{
 ...
 */
int
pr_setrlimit(struct ps_prochandle *Pr, int resource, const struct rlimit *rlp)
{
