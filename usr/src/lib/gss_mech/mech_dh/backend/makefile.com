...
MECH =	context.o context_establish.o cred.o crypto.o dhmech.o error.o \
	MICwrap.o name.o oid.o token.o support.o validate.o
...
#LINTFLAGS64 += -dirout=lent -errfmt=simple
LINTOUT =	lint.out
LINTSRC =	$(LINTLIB:%.ln=%)
