...
#pragma ident	"@(#)rpc_mt.h	1.15	97/08/25 SMI"
...
extern int __rpc_rlim_cur(void);
extern int __rpc_max_nofile;
...
#define	RPC_MAX_NOFILE	(__rpc_max_nofile ? __rpc_max_nofile : \
				(__rpc_max_nofile = __rpc_rlim_max()))
#define	RPC_FD_NOTIN_FDSET(x)	(!__rpc_use_pollfd_done && (x) >= FD_SETSIZE)
#define	RPC_MAX_FD	(__rpc_use_pollfd_done ? RPC_MAX_NOFILE : FD_SETSIZE)
