...
#pragma ident	"@(#)print_obj.c	1.19	97/11/19 SMI"
...
nis_print_object(nis_object *o)
{
	...
	(void) printf("Creation Time : %s", ctime(&p_time));
	p_time = (time_t)o->zo_oid.mtime;
	(void) printf("Mod. Time     : %s", ctime(&p_time));
