...
#pragma ident	"@(#)FNSP_HostnameContext.cc	1.11	97/10/31 SMI"
...
#define	IP_SIZE (16*4)	// maximum size of dotted IPv6 string ("129.144.40.71")
...
// eg:  In the ssi.eng.sun.com domain,
//	qualify("calvin", "smcc.eng.sun.com.") produces "calvin.smcc".
...
//
// e.g 	cname=mufasa,addr=129.144.40.38
