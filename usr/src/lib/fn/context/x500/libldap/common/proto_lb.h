...
#pragma ident	"@(#)proto-lber.h	1.2	97/11/07 SMI"
...
LIBIMPORT unsigned int ber_get_boolean(BerElement *ber, int *bool);
...
LIBIMPORT int ber_put_boolean(BerElement *ber, int bool, unsigned int tag);
