#
#ident	"@(#)Makefile.com	1.34	98/01/14 SMI"
#
...
cprbooter: ucper.o $(CPRBOOTER_MAPFILE) 
	$(LD) -dn -M $(CPRBOOTER_MAPFILE) $(MAP_FLAG) -o $@ ucper.o
	$(POST_PROCESS)
...
cprbooter_lint: $(L_CEROBJ) $(LINTLIBCPR)
	@$(ECHO) "\nperforming global crosschecks: $@"
