#ident	"@(#)Makefile.com	1.113	97/11/12 SMI"
#
...
kadb:	ukadb.o pf.o mapfile $$(LIBS) $$(OTHERLIBS)
	${LD} -dn -M mapfile -e start -Bstatic -o $@ -z muldefs \
		ukadb.o pf.o $(LDLIBS) $(OTHERLIBS) -lc

kadbka:	ukadbka.o pf.o mapfile $$(LIBS) $$(OTHERLIBS)
	${LD} -dn -M mapfile -e start -Bstatic -o $@ -z muldefs \
		ukadbka.o pf.o $(LDLIBS) $(OTHERLIBS) -lc

kadbnetka:	ukadbnetka.o pf.o mapfile $$(LIBS) $$(OTHERLIBS)
	${LD} -dn -M mapfile -e start -Bstatic -o $@ -z muldefs \
		ukadbnetka.o pf.o $(LDLIBS) $(OTHERLIBS) -lc
...
ukadbka.o: ${AOBJ} ${OBJ} $(ADBOBJ) $(KA_OBJS) standalloc.o
	${LD} -r -o $@ ${AOBJ} ${OBJ} $(ADBOBJ) $(KA_OBJS)
...
$(LIBSA) $(LIBBOOT) $(LIBNAMES) $(KADBPROMLIB) $(PLATLIB) $(LIBNFS_INET): FRC
	@cd $(@D); pwd; $(MAKE) $(@F)
...
CSDIRS	= $(TOPDIR)/cmd/adb/$(CSMACH) $(TOPDIR)/cmd/adb/common \
	...
	$(TOPDIR)/stand/sys $(MACH_CSDIRS) $(COMDIR) .
