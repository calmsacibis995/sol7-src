...
#pragma ident	"@(#)kadb.c	1.59	97/11/24 SMI"
...
/* 
 * XX64 At some point we may want to make this
 * available to all archs instead of just v9 
 */
#include <time.h>
#include <sys/types.h>
#include <ctype.h>
...
extern void	gets();		/* kadb got its own */
extern void 	putchar();
#ifdef _LP64
...
#define NPS (WORDSIZE*8)
		...
		if((List[i] = (TREE *) _malloc_unlocked((size+WORDSIZE)*NPS)) == NULL)
			return NULL;
