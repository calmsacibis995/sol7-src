...
#pragma ident	"@(#)boot.c	1.58	98/02/12 SMI"
...
#ifdef	_LP64
extern char	*choose_default_filename(char *defname32, char *defname64);
extern void	get_boot_args(char *bargs);
#endif	/* _LP64 */
...
main(void *cookie, char **argv, int argc)
{
	...
	set_default_filename(defname32);
...
loop:
	 ...
	 */
	set_default_filename(choose_default_filename(defname32, defname64));
