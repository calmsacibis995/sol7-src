...
#pragma ident	"@(#)int_entry.s	1.20	98/02/12 SMI"
...
/*
 * Nothing in this file is interesting to lint, except function
 * declarations which are at the end.
 */
...
/ label below is used in trap.c to detect FP faults in kernel due to user
/ fault.
...
pftrap:
	...
	.align	4
	.globl	pentium_pftrap
pentium_pftrap:
	pushl	%eax
	movl	%cr2, %eax
	andl	$MMU_STD_PAGEMASK, %eax
	cmpl	%eax, %cs:KIDTptr+2
