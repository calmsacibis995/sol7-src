...
#ident	"@(#)mcount.s	1.8	97/07/28 SMI"
...
_mcount:
	...
	/ We can't look at our CPU structure until it's been initialized.
	/ This "ret" will be hot-patched to a "nop" after the CPU structure
	/ and GDT have been initialized.  The ret _must_ be the first 
	/ instruction in _mcount;  if you change this, be sure to change 
	/ the hot-patching code in locore.
	ret
