...
#pragma ident	"@(#)e80387.h	1.3	97/05/24 SMI"
...
#define	FPCTXSIZE			27	/* words in FP context */
...
#define	fpdata				220	/* 27 longs */
#define	fpdata_last			FPCTXSIZE \* 4 + fpdata - 4
#define	global_reent_seg_length		FPCTXSIZE \* 4 + fpdata
...
#define	offset_gs	global_reent_seg_length
#define	offset_eax	global_reent_seg_length + 44
#define	int_esp		global_reent_seg_length + 68
#define	EIP_offset	global_reent_seg_length + 56	/* EIP for iret */
 ...
 *
 *
 *  The Status Register structure is addressed by the GS segment register
 *
 */

#define	sr_masks 	fpdata + 0
#define	sr_controls	fpdata + 1
#define	sr_reserved1 	fpdata + 2
#define	sr_errors 	fpdata + 4
#define	sr_flags 	fpdata + 5
#define	sr_reserved2 	fpdata + 6
#define	sr_tags 	fpdata + 8
#define	sr_reserved3 	fpdata + 10
#define	sr_instr_offset fpdata + 12
#define	sr_instr_base 	fpdata + 16
#define	sr_reserved4 	fpdata + 18
#define	sr_mem_offset 	fpdata + 20
#define	sr_mem_base 	fpdata + 24
#define	sr_reserved5 	fpdata + 26
#define	sr_regstack 	fpdata + 28
/

#define	SR_SEG		%ss
#define	SR_MASKS	sr_masks(%ebp)
#define	SR_CONTROLS	sr_controls(%ebp)
#define	SR_ERRORS	sr_errors(%ebp)
#define	SR_FLAGS	sr_flags(%ebp)
#define	SR_TAGS		sr_tags(%ebp)
#define	SR_INSTR_OFFSET sr_instr_offset(%ebp)
#define	SR_INSTR_BASE   sr_instr_base(%ebp)
#define	SR_MEM_OFFSET   sr_mem_offset(%ebp)
#define	SR_MEM_BASE	sr_mem_base(%ebp)
#define	SR_REGSTACK	sr_regstack(%ebp)
