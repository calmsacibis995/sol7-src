...
#pragma ident	"@(#)swtch.s	1.39	98/01/07 SMI"
...
{}
	...
	/*
	 * if new proc is a kernel thread, it is already mapped.
	 */
...
not_kernel_address_space:
	/*
	 *
	 * if (CPU->cpu_current_hat == in-coming-procp->p_as->a_hat)
	 *	return;
	 */
