...
#pragma ident "@(#)sysi86.c	1.28	97/10/22 SMI"
	...
	rval_t *rvp;
{
	...
	/* real time clock management commands */
		...
		case GGMTL:
			if (suword32((void *)uap->arg1, ggmtl()) == -1)
				error = EFAULT;
			break;
