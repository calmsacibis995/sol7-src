...
#pragma ident	"@(#)i2o_impl.h	1.5	98/01/15 SMI"
...
typedef struct i2o_msg_trans {
    ...
    u_int		(* i2o_trans_msg_alloc)(i2o_nexus_handle_t
				nexus_handle);
    int			(* i2o_trans_msg_send)(i2o_nexus_handle_t nexus_handle,
				u_int mfa);
    u_int		(* i2o_trans_msg_recv)(i2o_nexus_handle_t nexus_handle);
    void		(* i2o_trans_msg_freebuf)(i2o_nexus_handle_t
				nexus_handle, u_int mfa);
