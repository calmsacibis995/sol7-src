...
#pragma ident	"@(#)scsi_subr.c	1.71	97/07/07 SMI"
...
/*PRINTFLIKE4*/
static void impl_scsi_log(dev_info_t *dev, char *label, u_int level,
    const char *fmt, ...);
static void v_scsi_log(dev_info_t *dev, char *label, u_int level,
...
static char *
scsi_asc_search(u_int asc, u_int ascq,
...
static char *
scsi_asc_ascq_name(u_int asc, u_int ascq, char *tmpstr,
	struct scsi_asq_key_strings *list)
{
	char *message;
...
scsi_vu_errmsg(struct scsi_device *devp, struct scsi_pkt *pkt, char *label,
    ...
    char *(*decode_fru)(struct scsi_device *, char *, int, u_char))
{
	u_char com;
...
static void
impl_scsi_log(dev_info_t *dev, char *label, u_int level,
    const char *fmt, ...)
{
	va_list ap;
...
static void
v_scsi_log(dev_info_t *dev, char *label, u_int level,
    const char *fmt, va_list ap)
{
