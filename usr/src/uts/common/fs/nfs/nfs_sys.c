...
#pragma ident	"@(#)nfs_sys.c	1.29	97/09/23 SMI"	/* SVr4.0 1.5	*/
 ...
 * publication.
 *
 * Copyright (c) 1986-1989,1993,1994,1995,1997 by Sun Microsystems, Inc.
	...
	case LM_SVC: { /* LM server daemon */
		...
		if (get_udatamodel() != DATAMODEL_NATIVE) {
			...
			lsa.retransmittimeout = STRUCT_FGET(ulsa,
			    retransmittimeout);
			lsa.max_threads = STRUCT_FGET(ulsa, max_threads);
		} else {
