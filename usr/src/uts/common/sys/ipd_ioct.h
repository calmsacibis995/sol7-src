...
#pragma ident	"@(#)ipd_ioctl.h	1.8	98/01/06 SMI"
 ...
 */
typedef struct {
	ulong_t			msg;		/* IPD_DIS_IND */
	enum ipd_iftype		iftype;		/* IPD_PTP or IPD_MTP */
	uint_t			ifunit;		/* interface unit number */
	struct sockaddr		sa;		/* address for this request */
	ulong_t			reason;		/* disconnect reason */
} ipd_dis_ind_t;
 ...
 */
typedef struct {
	ulong_t			msg;		/* IPD_ERR_IND */
	enum ipd_iftype		iftype;		/* IPD_PTP or IPD_MTP */
	uint_t			ifunit;		/* interface unit number */
	struct sockaddr		sa;		/* address for this request */
	ulong_t			error;		/* error code */
} ipd_err_ind_t;
 ...
 */
typedef struct {
	ulong_t			msg;		/* IPD_SET_TIM */
	enum ipd_iftype		iftype;		/* IPD_PTP or IPD_MTP */
	uint_t			ifunit;		/* interface unit number */
	struct sockaddr		sa;		/* address for this request */
	ulong_t			timeout;	/* timeout in seconds */
} ipd_set_tim_t;
 ...
 */
typedef struct {
	ulong_t			msg;		/* IPD_BLACKLIST */
	enum ipd_iftype		iftype;		/* IPD_PTP or IPD_MTP */
	uint_t			ifunit;		/* interface unit number */
	struct sockaddr		sa;		/* address for this request */
	ulong_t			blacklisttime;	/* blacklist time in seconds */
} ipd_blacklist_t;
