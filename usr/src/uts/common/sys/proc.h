...
#pragma ident	"@(#)proc.h	1.115	98/01/29 SMI"	/* SVr4.0 11.65 */
...
typedef struct	proc {
	...
	ushort_t p_prwant;		/* /proc: process wanted for locking */
...
extern	void	installctx(
    kthread_id_t, void *, void (*)(), void (*)(), void (*)(), void (*)());
extern	int	removectx(
    kthread_id_t, void *, void (*)(), void (*)(), void (*)(), void (*)());
