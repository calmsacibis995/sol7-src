...
#pragma ident	"@(#)pcalloc.h	1.8	97/01/28 SMI"
...
/*
 * structure for the list of resource lists
 */

struct ra_map_list {
	struct ra_map_list *ra_next;
	dev_info_t   *ra_dip;
	struct ramap *ra_mem;
	struct ramap *ra_io;
};
...
struct ra_map_list *ra_find_mapset(dev_info_t *);
int ra_init_null(dev_info_t *);
