...
#pragma ident	"@(#)stropts.h	1.42	97/12/06 SMI"	/* SVr4.0 11.20	*/
...
/*
 * These types exist because the XTI/TPI/DLPI standards had to use them
 * instead of int32_t and uint32_t because DEC had shipped 64-bit wide.
 * They are here as their primary location because they may be needed by
 * users of I_FDINSERT too.
 */
