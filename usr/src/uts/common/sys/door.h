...
#pragma ident	"@(#)door.h	1.17	98/01/06 SMI"
...
#ifdef _KERNEL
#define	DOOR_KERNEL_FP	0x20000 /* A kernel file structure is being passed */
#endif
...
#ifdef _KERNEL
		/* Kernel passes file structures referring to doors */
		struct file *d_fp;
#endif
		/* Reserved space */
		int		d_resv[5];
...
struct file *door_create_kernel(void (*)(void *, door_arg_t *,
    void (**)(void *, void *), void **, int *), void *, uint_t);
int	door_revoke(int);
