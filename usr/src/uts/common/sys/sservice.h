...
#pragma ident	"@(#)sservice.h	1.45	98/01/06 SMI"
...
ddi_intrspec_t pcmcia_get_intrspec(dev_info_t *, dev_info_t *, uint_t);
int pcmcia_add_intrspec(dev_info_t *, dev_info_t *, ddi_intrspec_t,
			    ddi_iblock_cookie_t *, ddi_idevice_cookie_t *,
			    uint_t (*)(caddr_t), caddr_t, int);
void pcmcia_remove_intrspec(dev_info_t *, dev_info_t *, ddi_intrspec_t,
			    ddi_iblock_cookie_t);
...
int pcmcia_alloc_mem(dev_info_t *, ra_request_t *, ra_return_t *);
int pcmcia_alloc_io(dev_info_t *, ra_request_t *, ra_return_t *);
int pcmcia_free_mem(dev_info_t *, ra_return_t *);
int pcmcia_free_io(dev_info_t *, ra_return_t *);
int pcmcia_init_mem(dev_info_t *, ra_return_t *);
int pcmcia_init_io(dev_info_t *, ra_return_t *);
