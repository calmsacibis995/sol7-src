...
#pragma ident	"@(#)vnode.h	1.77	98/02/13 SMI"
...
typedef struct vnodeops {
	...
	int	(*vop_pageio)(struct vnode *vp, struct page *pp,
				...
				struct cred *cr);
	int	(*vop_dumpctl)(struct vnode *vp, int free);
	void	(*vop_dispose)(struct vnode *vp, struct page *pp, int fl,
...
int	vn_vfsrlock_held(struct vnode *vp);
