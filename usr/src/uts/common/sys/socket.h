...
#pragma ident	"@(#)socket.h	1.42	97/11/24 SMI"	/* SVr4.0 1.10	*/
...
#if defined(_XPG4_2) || defined(_LP64)
typedef	socklen_t	*Psocklen_t;
#else
typedef	void		*Psocklen_t;
#endif	/* defined(_XPG4_2) || defined(_LP64) */
...
#define	CMSG_NXTHDR(m, c)						\
	((((uintptr_t)c) + ((struct cmsghdr *)c)->cmsg_len +		\
