...
#pragma ident	"@(#)hwconf.h	1.10	97/04/21 SMI"
...
extern struct par_list *impl_read_driver_conf(major_t major);
extern void impl_free_driver_conf(struct par_list *plist);
