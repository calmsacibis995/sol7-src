...
#pragma ident	"@(#)class.h	1.32	97/05/23 SMI"
...
typedef struct classfuncs {
	struct class_ops {
		...
		int		(*cl_parmsin)(void *, id_t, cred_t *, id_t,
				    cred_t *, void *);
		int		(*cl_parmsout)(void *, id_t, cred_t *, id_t,
				    cred_t *, void *);
		int		(*cl_getclpri)(pcpri_t *);
	} sclass;
	struct thread_ops {
		int		(*cl_enterclass)(kthread_id_t, id_t, void *,
				    cred_t *, void *);
		...
		int		(*cl_parmsset)(kthread_id_t, void *, id_t,
				    cred_t *);
		...
		int		(*cl_donice)(kthread_id_t, cred_t *,
				    int, int *);
...
typedef struct sclass {
	...
	void	(*cl_init)(id_t, int, struct classfuncs **, pri_t *, size_t *);
