...
#pragma ident	"@(#)mman.h	1.30	98/01/20 SMI"	/* SVr4.0 1.15	*/
...
/* XX64 - make sure the different ABIs have different ZFOD protections */
#define	PROT_ZFOD64	(PROT_READ | PROT_WRITE | PROT_USER)
#define	PROT_ZFOD	(PROT_READ | PROT_WRITE | PROT_EXEC | PROT_USER)
#elif defined(__sparc) || defined(sparc) || defined(__i386) || defined(i386)
#define	PROT_ZFOD	(PROT_READ | PROT_WRITE | PROT_EXEC | PROT_USER)
#else
