...
#pragma ident	"@(#)cdio.h	1.13	97/09/25 SMI"
...
#define	cdrom_cdda32tocdrom_cdda(cdda32, cdda)			\
	...
	cdda->cdda_data		= (caddr_t)cdda32->cdda_data;	\
...
#define	cdrom_cddatocdrom_cdda32(cdda, cdda32)			\
	...
	cdda32->cdda_data	= (caddr32_t)cdda->cdda_data;	\
...
#define	cdrom_cdxa32tocdrom_cdxa(cdxa32, cdxa)				\
	...
	cdxa->cdxa_data		= (caddr_t)cdxa32->cdxa_data;		\
...
#define	cdrom_cdxatocdrom_cdxa32(cdxa, cdxa32)				\
	...
	cdxa32->cdxa_data	= (caddr32_t)cdxa->cdxa_data;		\
