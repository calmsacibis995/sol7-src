...
#pragma ident	"@(#)autoconf.h	1.24	97/05/14 SMI"
...
struct devnames {
	...
	dev_info_t *dn_newdevs;		/* head of new hotplugged dev_info */
};
...
struct bind;
extern void make_mbind(char *, int, struct bind **, char *);

extern char *get_impl_module(int first);
