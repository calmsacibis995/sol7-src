...
#pragma ident	"@(#)stream.h	1.78	98/02/01 SMI"	/* SVr4.0 11.44	*/
 ...
 * (i.e. q_wait).
 *
 * q_draining and q_syncqmsgs are special - they are protected by
 * SQLOCK(q->syncq).
 */
...
typedef struct	queue {
	...
	ushort_t	q_draining;	/* locked by SQLOCK - drain_syncq */
...
extern void qwriter(queue_t *, mblk_t *, void (*)(), int);
extern timeout_id_t qtimeout(queue_t *, void (*)(void *), void *, clock_t);
