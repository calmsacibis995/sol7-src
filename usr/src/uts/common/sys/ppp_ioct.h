...
#pragma ident	"@(#)ppp_ioctl.h	1.14	98/01/06 SMI"
...
typedef struct {
	...
	ulong_t		pppLinkLocalMRU;		/* bytes */
	ulong_t		pppLinkRemoteMRU;		/* bytes */
	uint_t		pppLinkLocalACCMap;		/* not used */
	ulong_t		pppIPLocalAddr;			/* for IP addr neg */
	ulong_t		pppIPRemoteAddr;
