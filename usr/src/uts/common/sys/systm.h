...
#pragma ident	"@(#)systm.h	1.86	98/02/07 SMI"
...
extern caddr_t	kernelheap;	/* start of kernel heap */
extern caddr_t	ekernelheap;	/* end of kernel heap */
...
char *copyoutstr_noerr(char *, const char *, size_t *);
...
extern void param_calc(int, int);
...
#define	NSYSCALL 	253		/* number of system calls */
...
extern int64_t loadable_syscall(long, long, long, long, long, long);
