...
#pragma ident	"@(#)dditypes.h	1.24	98/01/06 SMI"
...
typedef struct ddi_nofault_data {
	uchar_t version;		/* Version of this interface */
	uchar_t op_type;		/* Operation performed */
	ulong_t pfn;			/* Phys pfn generating nofault */
