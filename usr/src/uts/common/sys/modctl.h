...
#pragma ident	"@(#)modctl.h	1.50	98/01/13 SMI"	/* SunOS-4.1 1.9 */
...
/*PRINTFLIKE1*/
extern void modprintf(const char *, ...);
extern void modvprintf(const char *, va_list);
...
extern uintptr_t install_stub(struct mod_stub_info *);
