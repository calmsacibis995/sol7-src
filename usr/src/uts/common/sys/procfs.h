...
#pragma ident	"@(#)procfs.h	1.15	98/02/13 SMI"
...
typedef struct pstatus {
	...
	char	pr_pad[3];
	int	pr_filler[19];	/* reserved for future use */
...
/*
 * Extended memory-map interface.  /proc/<pid>/xmap
 */
typedef struct prxmap {
	...
	ulong_t	pr_ashared;	/* pages of anon that are shared */
	ulong_t	pr_aref;	/* pages of anon that are referenced */
	ulong_t	pr_amod;	/* pages of anon that are modified */
	ulong_t	pr_vnode;	/* pages resident associated with a vnode */
	ulong_t	pr_vshared;	/* pages of vnode that are shared */
	ulong_t	pr_vref;	/* pages of vnode that are referenced */
	ulong_t	pr_vmod;	/* pages of vnode that are modified */
	ulong_t	pr_filler[4];	/* filler for future expansion */
} prxmap_t;
...
typedef struct pstatus32 {
	...
	id32_t	pr_aslwpid;	/* lwp id of the aslwp, if any */
...
/*
 * _ILP32 Extended memory-map interface.  /proc/<pid>/xmap
 */
typedef struct prxmap32 {
	...
	uint32_t pr_ashared;	/* pages of anon that are shared */
	uint32_t pr_aref;	/* pages of anon that are referenced */
	uint32_t pr_amod;	/* pages of anon that are modified */
	uint32_t pr_vnode;	/* pages resident associated with a vnode */
	uint32_t pr_vshared;	/* pages of vnode that are shared */
	uint32_t pr_vref;	/* pages of vnode that are referenced */
	uint32_t pr_vmod;	/* pages of vnode that are modified */
	uint32_t pr_filler[4];	/* filler for future expansion */
} prxmap32_t;
