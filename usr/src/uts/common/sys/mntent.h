 ...
 * publication.
 *
 *	(c) 1991,1996,1997 Sun Microsystems, Inc.
...
#pragma ident	"@(#)mntent.h	1.28	97/06/09 SMI"	/* SVr4.0 1.4	*/
...
#define	MNTTYPE_PC	"pc"		/* PC (MSDOS) file system */
...
#define	MNTOPT_TOOSOON	"toosoon"	/* min. time between inconsistencies */
