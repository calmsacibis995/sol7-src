...
#pragma ident	"@(#)i2omstr.h	1.4	98/01/12 SMI"
...
typedef struct i2o_bsa_storage_hist_stats_scalar {
    u_longlong_t	ReadCommands;
    u_longlong_t	WriteCommands;
    uint8_t		DataUnit;
    uint8_t		reserved1;
    uint16_t		reserved2;
    u_longlong_t	IORange1Read;
    u_longlong_t	IORange2Read;
    u_longlong_t	IORange3Read;
    u_longlong_t	IORange4Read;
    u_longlong_t	IORange1Write;
    u_longlong_t	IORange2Write;
    u_longlong_t	IORange3Write;
    u_longlong_t	IORange4Write;
    u_longlong_t	NumberSeeks;
...
typedef struct i2o_bsa_cache_hist_stats_scalar {
    u_longlong_t	CacheAccess;
    u_longlong_t	CacheHit;
    u_longlong_t	PartialCacheHit;
    u_longlong_t	HitDataSize;
    uint32_t		ValidUsage;
    uint32_t		DirtyUsage;
...
typedef struct i2o_bsa_volume_info_scalar {
    uint8_t		Name[64];
    u_longlong_t	TotalStorageCapacity;
    u_longlong_t	StripeLength;
    u_longlong_t	InterleaveDepth;
...
typedef struct i2o_bsa_pro_space_ext_scalar {
    u_longlong_t	StartAddress;
    u_longlong_t	NumberBlocks;
    uint32_t		BlockSize;
...
typedef struct i2o_bsa_phys_ext_scalar {
    ...
    u_longlong_t	CheckDataInterleave;
    u_longlong_t	CheckData;
    u_longlong_t	UserData;
...
typedef struct i2o_bsa_error_reply_message_frame {
    i2o_bsa_reply_message_frame_t	BsaReplyFrame;
    uint32_t				TransferCount;
    u_longlong_t			LogicalByteAddress;
