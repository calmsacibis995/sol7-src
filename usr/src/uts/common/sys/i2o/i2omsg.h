...
#pragma ident	"@(#)i2omsg.h	1.11	98/01/12 SMI"
...
typedef union {
	...
	u_longlong_t	initiator_context_64bits;
} i2o_initiator_context_t;

typedef u_longlong_t i2o_transaction_context_t;
...
/* MCA Bus */
typedef struct i2o_mca_bus_info {
	uint16_t		McaBaseIOPort;
	uint8_t			reserved;
	uint8_t			McaSlotNumber;
	uint32_t		McaBaseMemoryAddress;
} i2o_mca_bus_info_t;
