 ...
 * publication.
 *
 *	(c) 1986,1987,1988,1989,1998  Sun Microsystems, Inc
...
#pragma ident	"@(#)vmmac.h	2.32	98/02/12 SMI"	/* SVr4.0 1.7 */
 ...
 */
#define	kmxtob(a)	(kernelheap + ((a) << MMU_PAGESHIFT))
#define	btokmx(b)	\
	((uintptr_t)((caddr_t)(b) - kernelheap) >> MMU_PAGESHIFT)
