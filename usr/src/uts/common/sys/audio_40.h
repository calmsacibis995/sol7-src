...
#pragma ident	"@(#)audio_4231.h	1.22	98/01/06 SMI"
...
struct aud_4231_pioregs {
	uchar_t iar;		/* Index Address Register */
	uchar_t pad[3];		/* PAD  */
	uchar_t idr;		/* Indexed Data Register */
	uchar_t pad1[3];	/* PAD */
	uchar_t statr;		/* Status Register */
	uchar_t pad2[3];	/* PAD */
	uchar_t piodr;		/* PIO Data Register I/O */
	uchar_t pad3[3];	/* PAD */
};
...
/* #endif						*/
	...
	char *model;			/* version of audio hardware */
	boolean_t internal_loopback;	/* loopbacks for test support */
...
/*
 * Controller interrupt statistics
 */
#define	KIOIP		KSTAT_INTR_PTR(unitp->intrstats)
 ...
 */
#define	XCTL0_OFF	0x01	/* == speaker enable */
#define	XCTL0_ON	0x02
