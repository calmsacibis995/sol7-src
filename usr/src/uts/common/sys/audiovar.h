...
#pragma ident	"@(#)audiovar.h	1.30	98/01/06 SMI"
...
extern void	audio_ack(queue_t *q, mblk_t *mp, int error);
extern void	audio_copyin(queue_t *q, mblk_t *mp, caddr_t addr, uint_t len);
extern void	audio_copyout(queue_t *q, mblk_t *mp, caddr_t addr, uint_t len);
