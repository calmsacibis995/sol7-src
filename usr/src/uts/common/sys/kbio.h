...
#pragma ident	"@(#)kbio.h	1.32	98/01/06 SMI"	/* SunOS4.0 1.23 */
 ...
 * KIOCSKABORTEN:
 *
 * Enable/Disable Keyboard abort effect (Stop/A, Break or other seq).
 * The argument is a pointer to an integer.  If the integer is zero,
 * keyboard abort is disabled. Otherwise, keyboard abort
 * is enabled. NB: This ioctl requires root credentials.
 */
