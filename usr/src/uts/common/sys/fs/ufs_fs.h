...
#pragma ident	"@(#)ufs_fs.h	2.57	98/01/06 SMI"
...
/* these fields retain the current block allocation info */
	...
	int32_t	fs_sparecon[55];	/* reserved for future constants */
#define	fs_logbno fs_sparecon[52]	/* block # of embedded log */
#define	fs_reclaim fs_sparecon[53]	/* reclaim open, deleted files */
#ifdef _LITTLE_ENDIAN
	/* USL SVR4 compatibility */
	int32_t	fs_npsect;		/* # sectors/track including spares */
#else
...
/*
 * The cast to long does not result in any loss of information because
 * max size of file system and file is 1 terabyte and therefore logical
 * block no is still a 32 bit value.
 */
