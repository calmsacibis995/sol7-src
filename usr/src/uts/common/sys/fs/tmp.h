/*
 * Copyright (c) 1989-1991, 1996-1998 by Sun Microsystems, Inc.
 * All rights reserved.
 */
...
#pragma ident	"@(#)tmp.h	1.26	98/02/04 SMI"
...
struct tmpfs_args {
	size_t		anonmax;	/* maximum size for this file system */
	uint_t		flags;		/* flags for this mount */
};
