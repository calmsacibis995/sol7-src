...
#pragma ident	"@(#)strredir.h	1.6	97/03/06 SMI"
...
/*
 * The console output subsystem (i.e., the writekmsg routine) needs to
 * determine the current redirection target and prevent new redirections
 * while sending messages to that stream.
 */
extern vnode_t *srredirecteevp_lookup(void);
extern void srredirecteevp_rele(void);
