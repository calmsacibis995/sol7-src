...
#pragma ident	"@(#)siginfo.h	1.53	98/02/06 SMI"	/* SVr4.0 1.20 */
...
union __sigval {
	long	__sival_int;	/* integer value */
...
struct sigevent32 {
	...
	union {
		int32_t		_sigev_signo;	/* signal number */
		caddr32_t	_sigev_notify_function;
	} _sigev_un;
	union sigval32	sigev_value;	/* signal value */
	int32_t		_sigev_pad1;
	caddr32_t	_sigev_notify_attributes;
	int32_t		_sigev_pad2;
};
