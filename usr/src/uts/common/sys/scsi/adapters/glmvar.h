...
#pragma ident	"@(#)glmvar.h	1.69	98/01/08 SMI"
...
struct glm_hba_dsa {
	struct	{
		uchar_t	g_pad0;		/* currently unused */
...
#define	NSS_FUNCS	9	/* number of defined SCRIPT functions */
...
#define	GLM_START_SCRIPT(P, script) ddi_put32(glm->g_datap, \
...
#define	NINT_IWR	0xff15		/* Ignore wide residue. */
