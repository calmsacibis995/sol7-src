...
#pragma ident	"@(#)gen_oids.c	1.13	98/01/22 SMI"
 ...
 * in GSS-API Specs.
 */
const gss_OID GSS_C_NT_USER_NAME = (const gss_OID)oids+0;
const gss_OID GSS_C_NT_MACHINE_UID_NAME = (const gss_OID)oids+1;
const gss_OID GSS_C_NT_STRING_UID_NAME = (const gss_OID)oids+2;
const gss_OID GSS_C_NT_HOSTBASED_SERVICE = (const gss_OID)oids+4;
const gss_OID GSS_C_NT_ANONYMOUS = (const gss_OID)oids+5;
const gss_OID GSS_C_NT_EXPORT_NAME = (const gss_OID)oids+6;
