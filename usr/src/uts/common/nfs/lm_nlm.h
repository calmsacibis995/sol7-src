 ...
 * derived under license from AT&T's Unix(r) System V. In addition, portions of
 * such source code were derived from Berkeley 4.3 BSD under license from the
 ...
 * Copyright Notice
 *
 * Notice of copyright on this source code product does not indicate publication
 *
 * Copyright (c) 1986-1989,1994,1997-1998 by Sun Microsystems, Inc.
 * All rights reserved.
 *
...
#pragma ident	"@(#)lm_nlm.h	1.12	98/01/06 SMI"	/* NCR OS2.00.00 1.1 */
