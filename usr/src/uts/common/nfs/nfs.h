 ...
 *  publication.
 *
 *	Copyright (c) 1986-1991,1994-1998 by Sun Microsystems, Inc.
...
#pragma ident	"@(#)nfs.h	1.78	98/01/06 SMI"	/* SVr4.0 1.5	*/
...
struct nfsfattr {
	...
	struct timeval32 na_atime;	/* time of last access */
	struct timeval32 na_mtime;	/* time of last modification */
	struct timeval32 na_ctime;	/* time of last change */
};
...
struct nfssattr {
	...
	struct timeval32 sa_atime;	/* time of last access */
	struct timeval32 sa_mtime;	/* time of last modification */
};
...
extern bool_t	xdr_timeval32(XDR *, struct timeval32 *);
...
extern void	nattr_to_vattr(vnode_t *, struct nfsfattr *, struct vattr *);
...
extern gid_t	setdirgid(vnode_t *, cred_t *);
extern mode_t	setdirmode(vnode_t *, mode_t);
...
extern void	nfs_lockcompletion(vnode_t *vp, int cmd, struct flock64 *bfp);
...
extern void	fattr3_to_vattr(vnode_t *, fattr3 *, struct vattr *);
extern int	nfs3tsize(void);
extern void	vattr_to_sattr3(struct vattr *, sattr3 *);
