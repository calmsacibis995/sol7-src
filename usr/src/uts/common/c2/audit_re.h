...
#pragma ident	"@(#)audit_record.h	1.46	98/01/06 SMI"
...
#define	AUT_OTHER_FILE32	((char)0x11)
#define	AUT_OHEADER		((char)0x12)
#define	AUT_TRAILER		((char)0x13)
#define	AUT_HEADER32		((char)0x14)
...
#define	AUT_SUBJECT32		((char)0x24)
#define	AUT_SERVER32		((char)0x25)
#define	AUT_PROCESS32		((char)0x26)
#define	AUT_RETURN32		((char)0x27)
...
token_t *au_to_header(int, short, short);
...
token_t *au_to_seq();
token_t *au_to_process(struct proc *);
token_t *au_to_subject(struct proc *);
...
token_t *au_to_exec_args(char **, uintptr_t, int);
token_t *au_to_exec_env(char **, uintptr_t, int);
