...
#pragma ident	"@(#)seg.h	1.53	98/01/06 SMI"
 ...
 */
extern	void	seg_ppurge_all(void);
extern	void	seg_pupdate(void *dummy);
...
extern	void	seg_pinsert(struct seg *seg, caddr_t addr, size_t len,
			struct page **pp, enum seg_rw rw, void (*callback)());
