...
#pragma ident	"@(#)seg_dev.h	1.32	98/01/06 SMI"
...
struct	segdev_data {
	...
	uint_t	hat_flags;	/* hat flags - pass to attr in hat_devload */
	uint_t	hat_noconsist;	/* Set HAT_LOAD_NOCONSIST flag in hat_devload */
