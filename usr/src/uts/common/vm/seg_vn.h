...
#pragma ident	"@(#)seg_vn.h	1.43	98/01/06 SMI"
...
/*
 * A macro for the segvn_crargs argument to create user stacks;  the
 * prot field will be filled in with p_stkprot.
 */
#define	STACK_ZFOD_ARGS {	\
	(struct vnode *)NULL,	\
	(struct cred *)NULL,	\
	(u_offset_t)0,		\
	MAP_PRIVATE,		\
