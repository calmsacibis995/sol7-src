...
#pragma ident	"@(#)anon.h	1.63	98/02/04 SMI"
...
extern void	anon_dup(struct anon_hdr *old, ulong_t old_idx,
			struct anon_hdr *new, ulong_t new_idx, size_t size);
