 ...
 * $Author: jtkohl $
 * $Header: /mit/kerberos/src/include/RCS/krb.h,v 4.26 89/08/08 17:55:25 $
 *
...
#pragma ident	"@(#)krb.h	1.14	97/11/25 SMI"
...
struct ktext {
	...
	unsigned int mbz;			/* zero to catch runaway */
						/* strings */
};
...
/*
 * forward declaration; otherwise need to include netinet/in.h
 */
...
extern int krb_rd_req(KTEXT, char *, char *, int, AUTH_DAT *, char *);
extern int krb_kntoln(AUTH_DAT *, char *);
extern int krb_set_key(char *, int);
extern int krb_get_cred(char *, char *, char *, CREDENTIALS *);
extern int krb_mk_safe(unsigned char *, unsigned char *, unsigned int,
	C_Block *, struct sockaddr_in *, struct sockaddr_in *);
extern int krb_rd_safe(unsigned char *, unsigned int, C_Block *,
	struct sockaddr_in *, struct sockaddr_in *, MSG_DAT *);
extern int krb_mk_err(unsigned char *, int, char *);
extern int krb_rd_err(unsigned char *, unsigned int, int *, MSG_DAT *);
...
extern int krb_sendauth(int, int, KTEXT, char *, char *, char *, unsigned int,
	MSG_DAT *, CREDENTIALS *, Key_schedule, struct sockaddr_in *,
	struct sockaddr_in *, char *);
extern int krb_recvauth(int, int, KTEXT, char *, char *,
...
extern int krb_mk_safe();
extern int krb_rd_safe();
extern int krb_mk_err();
