...
#pragma ident	"@(#)svc.h	1.54	98/02/09 SMI"
...
struct xp_ops {
		...
		int32_t *(*xp_getres)(struct __svcxprt *, int);
...
#else
		bool_t	(*xp_control)(struct __svcxprt *, const uint_t,
		...
		int32_t *(*xp_getres)(); /* get pointer to response buffer */
...
typedef struct __svcxprt {
	...
	int32_t		xp_type;	/* transport type */
...
#ifndef _KERNEL
#ifdef __STDC__
extern bool_t	rpc_reg(const rpcprog_t, const rpcvers_t,
		const rpcproc_t, char *(*)(char *),
...
const rpcprog_t, const rpcvers_t, const struct netconfig *);
	/*
	 * void (*dispatch)();			-- dispatch routine
	 * const rpcprog_t prognum;		-- program number
	 * const rpcvers_t versnum;		-- version number
...
struct t_bind *, const uint_t, const uint_t);
/*
...
const rpcprog_t, const rpcvers_t, const uint_t);
/*
 * 	void (*dispatch)();			-- dispatch routine
 *	const rpcprog_t prognum;		-- program number
 *	const rpcvers_t versnum;		-- version number
