...
#pragma ident	"@(#)sysent.c	1.98	98/01/29 SMI"	/* SVr4.0 1.51	*/
 ...
 * For more args, use the SYSENT_*AP*() family of routines.
 *
...
#define	SYSENT_AP(name, call, narg)	\
	...
	/* returns one 32-bit value for both ABIs: r_val1 */
#define	SYSENT_API(name, call, narg)	\
	{ (narg), SE_32RVAL1, (call), NULL, syscall_ap }

	/* returns 2 32-bit values for both ABIs: r_val1 & r_val2 */
#define	SYSENT_2API(name, call, narg)	\
	{ (narg), SE_32RVAL1|SE_32RVAL2, (call), NULL, syscall_ap }
...
#define	SYSENT_APL(name, call, narg)	\
	IF_LP64(SYSENT_AP(name, call, narg), SYSENT_API(name, call, narg))
...
struct sysent sysent[NSYSCALL] =
{
	...
	/* 214 */ IF_LP64(
			SYSENT_NOSYS(),
			SYSENT_APL("smmaplf32",	smmaplf32,	7)),
	/* 215 */ IF_LP64(
			SYSENT_NOSYS(),
...
struct sysent sysent32[NSYSCALL] =
{
	...
	/* 70 */ SYSENT_LOADABLE32(),		/* (was advfs) */
	/* 71 */ SYSENT_LOADABLE32(),		/* (was unadvfs) */
	/* 72 */ SYSENT_LOADABLE32(),		/* (was notused) */
	/* 73 */ SYSENT_LOADABLE32(),		/* (was notused) */
	/* 74 */ SYSENT_LOADABLE32(),		/* (was rfstart) */
	/* 75 */ SYSENT_LOADABLE32(),		/* (was sigret (SunOS)) */
	/* 76 */ SYSENT_LOADABLE32(),		/* (was rdebug) */
	/* 77 */ SYSENT_LOADABLE32(),		/* (was rfstop) */
	/* 78 */ SYSENT_LOADABLE32(),		/* (was rfsys) */
	/* 79 */ SYSENT_CI("rmdir",		rmdir,		1),
	/* 80 */ SYSENT_CI("mkdir",		mkdir,		2),
	...
	/* 151 */ SYSENT_LOADABLE32(),		/* reserved */
	/* 152 */ SYSENT_CI("modctl",		modctl,		6),
	/* 153 */ SYSENT_CI("fchroot",		fchroot,	1),
	/* 154 */ SYSENT_CI("utimes",		utimes,		2),
	/* 155 */ SYSENT_CI("vhangup",		vhangup,	0),
	...
	/* 177 */ SYSENT_LOADABLE32(),
	/* 178 */ SYSENT_LOADABLE32(),		/* kaio */
	/* 179 */ SYSENT_LOADABLE32(),
	...
	/* 214 */ SYSENT_APL("smmaplf32", 	smmaplf32, 	7),
