...
#pragma ident	"@(#)vm_pageout.c	1.108	97/10/28 SMI"
...
clock_t	pageout_ticks;		/* number of ticks to be used by pageout */
clock_t	min_pageout_ticks;		/* the fewest we allow */
clock_t	max_pageout_ticks;		/* the most we allow */
