 ...
 * publication.
 *
 * 	Copyright (c) 1986-1989,1993-1994,1996-1997 by Sun Microsystems, Inc.
 * 	(c) 1983,1984,1985,1986,1987,1988,1989  AT&T.
 *		All rights reserved.
 *
 */

#pragma ident	"@(#)statvfs.c	1.13	97/09/26 SMI"	/* SVr4 1.42	*/
